...
export const IRON_LEGION_DETAILS = {
    ...
    protocols: {
        title: "Standing Field Engagement Protocols",
        description: "Standard operating procedures mandated for all field agents and expeditionary cohorts across hostile and neutral sectors.",
        list: [
            { id: "protocol_one", name: "Protocol One", text: "Protocol one, be courteous and allow your opponent the first attack." },
            { id: "protocol_two", name: "Protocol Two", text: "protocol two: attack back! It is time to show you the true strength of a iron legion." },
            { id: "protocol_six", name: "Protocol Six", text: "Protocol Six Retreat if you must. Your life is important too." },
            { id: "protocol_delta_9", name: "Protocol Delta-9", text: "Protocol Delta-9: Class-9 silence protocol and complete containment of classified operational sites." }
        ]
    }
};
