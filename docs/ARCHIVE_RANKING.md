# The Archive Ranking — why the standards are what they are

Reference material. **You do not need this to write a filing** — the standards
are already stated in [`STORY_FORMAT_GUIDE.md`](STORY_FORMAT_GUIDE.md) and
[`WHATIF_FORMAT_GUIDE.md`](WHATIF_FORMAT_GUIDE.md). Read this when you want to
know *why* a rule exists, or when you are arguing about standards.
...
## Why Wario ranks above Imp — full rationale
