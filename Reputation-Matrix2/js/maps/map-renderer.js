...
import { LORE_DATA } from '../pages/lore.js';
import { getIntelForFaction } from '../../systems/common.js';
import { playSound } from '../core/common.js';
import * as map from '../pages/maps.js';
import { resetTransform, getZoomLevel } from './map-transform.js';
import { QUEST_DATA } from '../data_modules/quests-data.js';
import { FACTION_COLORS } from './factions/faction-colors.js';
import { BATTLE_MAP_DATA } from './map-battle-data.js';
import { LEGAL_DATA } from '../pages/legal_data.js';
import { ALL_LEGAL_CODES } from '../data_modules/laws-data.js';
import { CULTURE_DATA } from '../pages/culture-data.js';
import { SPECIES_DATA, REGIONAL_DEMOGRAPHICS, SPECIES_ESTATE_BIAS } from '../data_modules/species-data.js';
import { PARTY_LOCATIONS } from '../data_modules/party-data.js';
import { PROVINCE_POLITICS } from '../data_modules/politics-data.js';
import { NATIONS, getTechTree, RESEARCH_CATEGORIES } from '../data_modules/research-data.js';
import { calculateAllAlliances } from '../pages/alliances-page.js';
// ============================================================================
// DOM REFERENCES
// ============================================================================
