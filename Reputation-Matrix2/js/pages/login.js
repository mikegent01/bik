...
import { getActiveAge, NATIONS, getTechTree, calculateRumorMetrics } from '../data_modules/research-data.js';
import { state, loadState } from '../core/state.js'; // Import state
