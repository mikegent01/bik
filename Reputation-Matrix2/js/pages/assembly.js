...
import { calculateRumorMetrics, calculateGlobalCycle } from '../data_modules/research-data.js';
...
async function loadDynamicData() {
    try {
        const dataModule = await import('../data_modules/assembly-data.js');
...
async function ensureEventPostsLoaded() {
    ...
    eventsPostsPromise = (async () => {
        try {
            const eventsModule = await import('../data_modules/assembly-events-data.js');
...
async function loadResearchModule() {
    if (!researchModulePromise) {
        researchModulePromise = import('../data_modules/research-data.js');
    }
