...
import { getAbsoluteDay, calculateGlobalCycle, getGlobalTechAverages } from '../data_modules/research-data.js';
import { WAHBOOK_POSTS } from '../data_modules/assembly-data.js';
import { getPlagueData, PLAGUE_LIFECYCLE, SPECIES_TAGS, getCurrentSeason } from '../data_modules/plagues-data.js';
