...
import { getPlagueData, PLAGUE_LIFECYCLE, SPECIES_TAGS, getKnownDiseases, getCurrentSeason } from '../data_modules/plagues-data.js';
import { calculateGlobalCycle, getGlobalTechAverages, NATIONS, getAbsoluteDay } from '../data_modules/research-data.js';
...
import { SPECIES_DATA } from '../data_modules/species-data.js';
import { calculateGlobalVitalStats } from '../data_modules/vital-stats-data.js';
