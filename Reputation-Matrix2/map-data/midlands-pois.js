...
const midlandsData = {
    pointsOfInterest: [
        // #66
        {
            ...
            description: "The administrative and symbolic heart of the Regal Empire, and the central district of Ironhold. It houses the ministries, high courts, and the residences of the most powerful non-noble bureaucrats.",
        ...
        },
        {
            ...
            type: 'capital_city',
            name: "Ironhold",
            description: "Capital of the Regal Empire, also known as Mighdural, and the heart of Iron Legion power: grey stone, straight lines, absolute order. Its inner quarters include the Imperial District and the Gilded Quarter. Efficiency replaced aesthetics here; documentation replaced culture.",
            factionId: 'iron_legion',
        ...
        },
        {
            ...
            description: "An elite financial house built high in the mountains above Mighdural. Enforces the Regal standard, rejects Mushroom Kingdom coin, and keeps the Empire's ledgers colder than its vaults.",
            factionId: 'regal_empire',
            intelReq: { faction: 'regal_empire', level: 20 },
            political_influence: 6,
            economic_value: 9,
        ...
        },
        {
            ...
            description: "A snow-swept encampment of the Snow Tribe of Arunedeal in the high Mighdurals, pitched between the Alpine Mountain Inn and the Legion's checkpoint wall.",
            factionId: 'unaligned',
            intelReq: 15,
            political_influence: 1,
            economic_value: 2,
        ...
        },
        {
            ...
            y: 5.5,
            type: 'fortress',
            name: "The Legion Wall Checkpoint (Mighdural Pass)",
            description: "A colossal stone checkpoint cutting clean across the Mighdural pass, garrisoned under Order 120. The banners snap; the wall does not open.",
            factionId: 'iron_legion',
        ...
        },
        {
            ...
            type: 'castle',
            name: "Vellanet Rise",
            description: "Jack Miser's granted holding on the Midlands periphery, upriver of the Mighdural foothill roads: a fortified manor, three villages, a mill, a quarry and the tolls between them. Eleven miles, give or take the moor.",
            factionId: 'regal_empire',
            intelReq: { faction: 'regal_empire', level: 15 },
            political_influence: 4,
            economic_value: 5,
        ...
        },
        {
            ...
            description: "A sprawling ranch complex at the edge of the grassland below the Mighdurals, serene retreat of Rohan's cavalry units when the capital lets them rest.",
            factionId: 'unaligned',
            intelReq: 10,
            political_influence: 1,
            economic_value: 4,
