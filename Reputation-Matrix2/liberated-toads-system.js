    ...
    dan: {
        ...
        relationships: {
         ...
         log: [
            ...
            { day: 22, event: "survival + Dan (paladin) assists Luigi in picking a lock, indicating cooperative problem-solving under pressure", xp: 50, type: "survival" },
            { day: 22, event: "intel + Dan (paladin) speculates the artifact may belong to an oracle, triggering investigative curiosity", xp: 50, type: "intel" },
        ]
    },
