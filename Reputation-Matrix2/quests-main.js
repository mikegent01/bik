...
export const MAIN_QUESTS = {
    ...
    'who_killed_peach': {
        ...
        steps: [
            ...
            { id: 'step4b', title: "Raventree Manor", status: 'active', description: "Following Bowser and Waluigi, the party arrived at the dilapidated Raventree Manor. Inside the Foyer (R02), they encountered the ghostly noble, Perrius, in the Parlor (R15). Lured away by a toad servant, Markop was forced to battle his own animated clothing. He then explored the decaying Eastern Hallway (R16e), finding a note: 'Don’t clean the mirrors.' In the Green Room (R19d), the oppressive silence made him realize he was alone. Meanwhile, Archie and Hjumpik navigated the treacherous, collapsing Western Hallway (R16w), where Archie became stuck. Markop, after a nerve-wracking tour of the upstairs rooms including the Daughter's Bedroom (R17) and the Yellow Room (R19e), finally panicked and rushed back to find his trapped companion. The party has now regrouped in the decrepit halls, wary of the manor's secrets." },
