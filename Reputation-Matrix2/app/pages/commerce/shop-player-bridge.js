...
async function loadWallet(){try{const r=await fetch('../../../data/commerce/wallets.json',{cache:'no-cache'});walletData=await r.json();}catch(e){walletData={};}return walletData;}
