...
export const RUMORS = [
...

    {
        ...
        title: "Prison Deception: Warden's Tour & Mage's Demand",
        time_ago: "Today",
        description: "In the Capital prison, a guard awkwardly flirted with FNG Remi (shut down by Lario) and even gave a 'house tour.' He later caught 'Archie Writeman' picking a lock. Dan repeatedly bolted, locking the Vigilance’s doors. FNG spoke with Eager as Archie slipped deeper inside and Lario stole a guard logbook. The All-Seeing Mage arrived, unlocked the door, and demanded Eager’s magic be drained, while another guard smashed a window and dragged Eager toward transport. A scan of 'Archie Writeman' turned up nothing.",
        targets: ['remi', 'archie', 'lario', 'dan', 'eager', 'archmage_theron', 'iron_legion'],
        effects: {
            regal_empire: -15,
            iron_legion: -10,
            mages_guild: -10,
