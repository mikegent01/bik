...
export const TOADS_QUESTS = {
    ...
    'toads_rescue_eager': {
        ...
        objective: "Eager has been successfully extracted from the restaurant, but the party's escape has led them into the treacherous, lava-filled sewers beneath the capital. With their guide revealed as a traitor and a monstrous Behir blocking the path, the new objective is simple: survive.",
        ...
        steps: [
            ...
            { id: 'step4', title: "Out of the Frying Pan...", status: 'active', description: "Eager was successfully extracted from the restaurant, but the party was forced to flee into the capital's sewers. They are now with a treacherous Legion spy, facing a monstrous Behir and other dangers, all while on a desperate mission to save Dan's life." }
        ]
    },
