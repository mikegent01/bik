...
export const CONFLICT_DETAILS = {
    "The Planar Schism": {
        summary: "The fracturing of reality within Raventree Manor into three distinct timelines: Shadowfell, Feywild, and the Material Plane.",
        startYear: 1040,
        status: "active",
        rootCause: "The failed synchronization ritual on the 21st caused by the Oracle and Archie's unstable magic.",
        majorPhases: [
            { name: "The Split (Day 21)", description: "Party separated across dimensions." },
            { name: "The Shadow Dinner (Day 23)", description: "Archie and Bowser confront the Vampire Lords." },
            { name: "The Fey Heists (Day 24-26)", description: "Hjumpik and Wario loot the overgrown manor." },
            { name: "The Convergence (Day 30)", description: "Timelines begin to merge or collapse." }
        ],
        keyFactions: ['vigilance_crew', 'onyx_hand', 'corvinarus_lineage', 'mages_guild'],
        estimatedCasualties: "Unknown - Time is subjective in the Schism"
    },
...
// ========================================================================
// THE PLANAR SCHISM - SHADOWFELL TIMELINE
// ========================================================================
{
    id: 'shadowfell_dinner_massacre',
    name: "The Dinner of Damned Souls",
    conflict: "The Planar Schism",
    arc: 'raventree_manor',
    date: { year: 1040, monthIndex: 6, day: 23, hour: 20, minute: 0 },
    location: "Raventree Manor (Shadowfell) - Dining Hall",
    belligerents: {
        side_a: { name: "The Guests", factions: ['vigilance_crew', 'tea_leaf_syndicate'] },
        side_b: { name: "The Hosts", factions: ['onyx_hand', 'corvinarus_lineage'] }
    },
    commanders: { side_a: ["Archie ('Darman')", "Bowser", "Green T"], side_b: ["Orangus Cornelius", "Vivesna/Vivian"] },
    outcome: "stalemate",
    outcomeDetail: "Orangus shot. Usk mutilated. Vivesna reveals true identity. Party escapes via window.",
    casualties: { 
        side_a: "Minor (Archie mental trauma)", 
        side_b: "Orangus (Incapacitated), Multiple Vampires burned by Bowser" 
    },
    strategicValue: "critical",
    description: `<p>The diplomatic dinner hosted by the Vampire Lord Orangus Cornelius dissolved into chaos. Forced to vote on a sacrifice, Archie voted for the Archivist but was coerced into cutting off the prisoner Usk's finger to prove his loyalty.</p>
    <p>The stalemate broke when Green T, signaling Archie, shot Orangus with a concealed silver bullet. Simultaneously, Bowser flipped the main table and unleashed fire breath on the vampire court. In the confusion, 'Vivesna' ripped off a wig, revealing themselves as Vivian—a male thrall manipulating the succession.</p>
    <p>Archie and Green T leaped through a window into the rose bushes to escape, while Bowser remained behind to fight the vampire lords alone.</p>`,
    tacticalNotes: "Silver weapons and unpredictability (Green T's gun) disrupted the vampires' control of the engagement.",
    participatingCharacters: ['archie', 'bowser', 'green_t', 'orangus_cornelius', 'vivian']
},
{
    id: 'battle_twilight_grove',
    ...
    belligerents: {
        ...
        side_b: { name: "Mazebounds", factions: ['raventree_curse'] }
    },
    commanders: { side_a: ["Markop", "Remi", "Dan (Parallel)"], side_b: ["Lead Mazebound"] },
    outcome: "victory",
    outcomeDetail: "Mazebounds repelled. Dan revealed as a parallel timeline duplicate.",
    casualties: { side_a: "Salam (Injured), Remi (Exhausted)", side_b: "3 Mazebounds destroyed" },
    strategicValue: "medium",
    description: `<p>Markop, Remi, and the toad squad were ambushed by 'Mazebounds'—gray, singing grotesques that mocked the party in rhyme. The creatures attempted to separate the group, specifically targeting Dan.</p>
    <p>Markop used an undead remedy on his blade to melt the attackers, while Remi and Salam provided ranged support. During the fight, Dan revealed he was a 'Parallel Dan' from a timeline where the ritual failed differently, casting doubt on his true allegiance.</p>`,
    tacticalNotes: "Psychological warfare (singing enemies) requires strong mental fortitude to counter.",
    participatingCharacters: ['markop', 'remi', 'dan', 'salam', 'eager']
},

// ========================================================================
// THE PLANAR SCHISM - FEYWARD TIMELINE
// ========================================================================
{
    id: 'wario_vs_bramblefly',
    ...
    belligerents: {
        ...
        side_b: { name: "The Bramblefly", factions: ['unaligned'] }
    },
    commanders: { side_a: ["Wario"], side_b: ["Guardian Instinct"] },
    outcome: "victory",
    outcomeDetail: "Bramblefly blown up. Floor collapsed. Loot secured.",
    casualties: { side_a: "Wario (Fall damage)", side_b: "Terminated" },
    strategicValue: "low",
    description: `<p>Wario engaged the massive Guardian Bramblefly in the attic solarium. Feigning a peace offering, Wario presented a beautifully wrapped gift box containing a timed explosive.</p>
    <p>The resulting explosion destroyed the Bramblefly and collapsed the solarium floor. Wario fell to the lower level but survived, immediately looting a pile of treasure he landed in. Hjumpik and the toads witnessed the chaos from the hallway.</p>`,
    tacticalNotes: "Improvised explosives are effective against insectoid mega-fauna, though collateral damage to infrastructure is guaranteed.",
    participatingCharacters: ['wario', 'hjumpik']
},
{
    id: 'rescue_of_steely',
    ...
    belligerents: {
        ...
        side_b: { name: "Manor Staff", factions: ['corvinarus_lineage'] }
    },
    commanders: { side_a: ["Hjumpik"], side_b: ["Gregory the Goblin"] },
    outcome: "victory",
    outcomeDetail: "Steely (Mossy) rescued. Guards neutralized.",
    casualties: { side_a: "Toad Lee (Stabbed)", side_b: "Gregory (Incapacitated), 1 Guard (Melted/Healed)" },
    strategicValue: "low",
    description: `<p>Toad Lee tracked Remi's mechanical dog, Steely (Mossy), to a servant's toilet where it was being held for parts. A brawl ensued when the goblin guard Gregory refused to yield the 'scrap metal'.</p>
    <p>Rakasha, intoxicated by the manor's magic, accidentally melted a guard's face with a touch spell before Hjumpik intervened to de-escalate. Toad Lee secured the dog despite taking a knife wound.</p>`,
    tacticalNotes: "Retrieval missions in hostile territory require precise violence; Rakasha's lack of control nearly turned a rescue into a murder.",
    participatingCharacters: ['hjumpik', 'toad_lee', 'rakasha', 'gregory']
},

// ========================================================================
// SIDE STORIES & REAL WORLD
// ========================================================================
{
    ...
    belligerents: {
        ...
        side_b: { name: "Prison Garrison", factions: ['iron_legion'] }
    },
    commanders: { side_a: ["Bryan"], side_b: ["Garrison Mage"] },
    outcome: "victory",
    outcomeDetail: "Prisoners freed. Mage thrown into lava. Shield secured.",
    casualties: { side_a: "None", side_b: "Mage KIA, Guard maimed" },
    strategicValue: "medium",
    description: `<p>Bryan, on a side mission for the Toad God, infiltrated a prison colony island. To create a distraction, he incited a massive riot at Grilly's Bar. When a Legion mage refused to evacuate civilians, Bryan threw him into a pool of molten slag.</p>
    <p>He proceeded to chop off a guard's arm to secure a path to the Temple of the Stars, displaying a ruthless efficiency characteristic of the new Loyalist movement.</p>`,
    tacticalNotes: "Creating chaos (riots) is an effective cover for solo infiltration objectives.",
    participatingCharacters: ['bryan']
},
{
    id: 'toad_squad_vs_wario',
    name: "The Tome Heist",
    conflict: "Vigilance Crew Incidents",
    arc: 'early_adventures',
    date: { year: 1040, monthIndex: 6, day: 24, hour: 11, minute: 0 },
    location: "Magic Shop, Neutral Town",
    belligerents: {
        side_a: { name: "Toad Squad", factions: ['liberated_toads'] },
        side_b: { name: "Wario", factions: ['wario'] }
    },
    commanders: { side_a: ["Embercap"], side_b: ["Wario"] },
    outcome: "defeat",
    outcomeDetail: "Tome of Evil stolen. Embercap bitten. Debt accrued.",
    casualties: { side_a: "Embercap (Injured)", side_b: "None" },
    strategicValue: "low",
    description: `<p>Embercap, Dewdrop, and Erick attempted to pick up magical items ordered by Rakasha. Wario intercepted the transaction, stealing a 'Tome of Evil' worth 20,000 coins.</p>
    <p>A chaotic fight ensued inside the shop. Wario physically overpowered Embercap and Erick, withstood a freezing spell from the shopkeeper, and escaped by transforming into a bat. The Toads were left responsible for the damages.</p>`,
    tacticalNotes: "Wario's unpredictability and durability make him a difficult opponent for standard infantry.",
    participatingCharacters: ['embercap', 'dewdrop', 'erick', 'wario']
},
{
    id: 'hunt_for_the_mole',
    name: "The Hunt for the Mole",
    conflict: "The Aegis Uprising",
    arc: 'toad_liberation',
    date: { year: 1040, monthIndex: 7, day: 28, hour: 4, minute: 30 }, // Note: Month 7 (Harvestide)
    location: "Raventree Manor (Material) - Recovery Ward",
    belligerents: {
        side_a: { name: "Pond Patrol Remnants", factions: ['liberated_toads'] },
        side_b: { name: "The Mole", factions: ['iron_legion'] }
    },
    commanders: { side_a: ["Bones", "Speaker L"], side_b: ["The Assassin"] },
    outcome: "victory",
    outcomeDetail: "Assassination prevented. Mole captured.",
    casualties: { side_a: "None", side_b: "Mole (Captured/Injured)" },
    strategicValue: "high",
    description: `<p>Bones and Speaker L tracked a Legion 'Mole' inside the material Raventree Manor. The Mole attempted to assassinate a recovering Archie Miser in his bed.</p>
    <p>Bones tackled the assassin mid-air, while Speaker L secured the perimeter. Luigi aided by flashing his Poltergust light to disorient the attacker. The capture of the Mole secured Archie's safety and provided intel on Legion infiltration tactics.</p>`,
    tacticalNotes: "Protecting high-value targets (Archie) requires constant vigilance, even in 'secure' recovery zones.",
    participatingCharacters: ['bones', 'speaker_l', 'archie', 'luigi']
},
{
