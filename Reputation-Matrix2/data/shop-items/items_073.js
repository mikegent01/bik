...
export const ITEMS_073 = {
    ...
    'equestria_item_potion_of_elemental_harmony': {
        id: 'equestria_item_potion_of_elemental_harmony',
        name: "Potion of Elemental Harmony",
        description: "Brewed by master alchemists from the Crystal Empire, this potion temporarily grants resistance to one elemental damage type and allows you to briefly manipulate its effects. It smells faintly of glitter and surprisingly, rain.",
        category: SHOP_CATEGORIES.CONSUMABLES,
        price: 650,
        icon: '💧',
        stock: 78,
        ...
        stockType: 'in_stock',
        effects: [
            "resistance to fire damage (25%) for 30 seconds",
            "chance to unleash a small elemental blast on hit",
            "minor regeneration effect"
        ],
    ...
    'connectopia_resonance_crystal': {
        id: 'connectopia_resonance_crystal',
        name: "Harmonic Echo Fragment",
        description: "A pulsating crystal that seems to vibrate with the very energy of Connectopia. Holding it allows you to briefly perceive the interconnectedness of everything – mostly just a headache, but occasionally a useful insight… maybe.",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 1200,
        icon: '🔮',
        stock: 91,
        ...
        stockType: 'in_stock',
        effects: [
            "chance to reveal hidden crafting recipes",
