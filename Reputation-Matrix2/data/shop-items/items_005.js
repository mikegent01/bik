...
export const ITEMS_005 = {
  ...
  "changeling_hive_chitin_armor": {
    ...
    "description": "Crafted from the discarded chitin of changeling swarms, this armor shifts and molds to your form, offering protection and a touch of the unknown. The armor's surface is iridescent with hues that seem to change with every step you take, reflecting the ever-shifting nature of the changelings who crafted it. It provides not only physical defense but also an edge in social situations, granting advantage on attempts to impersonate any humanoid creature.",
    "category": "equipment",
    "price": 5900,
    "icon": "🐛",
    "stock": 6,
    "rarity": "rare",
    "effects": [
      "Shifting Armor: AC 13 + DEX modifier",
      "Social Edge"
    ],
    ...
    "effectDetails": [
      {
        "title": "Shifting Armor",
        "rules": "This armor provides the wearer with a +2 bonus to AC. It also has the ability to shift and mold to your form, granting advantage on checks made to impersonate any humanoid creature."
      },
      {
        "title": "Social Edge",
        "rules": "Once per long rest, you can use an action to transform your appearance as if under the effect of a 'Mirror Image' spell, providing temporary protection and distraction for 1 minute. This ability is limited to once every short or long rest."
      }
    ],
    "levelRequirementReason": "This armor requires at least third level to balance its defensive abilities and social bonuses.",
    "vendorReason": "The changeling hive has intimate knowledge of their own materials, allowing them to craft this unique piece of armor.",
    "shippingDetail": "Delivered by Disguised Parcel, ensuring the armor arrives in perfect condition and with a touch of mystery.",
    "usage": {
      "activation": "Action or Bonus Action",
      "duration": "1 minute (Social Edge) / Instantaneous (Shifting Armor)",
      "endsWhen": "Ends when the wearer no longer has any hit points. The Social Edge effect ends after 1 minute.",
      "charges": "Unlimited"
    },
    "priceReason": "The rare and versatile nature of this armor, combined with its unique properties, justifies a price point that reflects its value.",
    "priceOriginal": 19000,
    "priceReviewedAt": "2026-07-22T00:46:33.659509+00:00",
    "aiReviewedAt": "2026-07-22T00:46:33.659509+00:00",
    "aiReviewVersion": 1
  },
  ...
  "changeling_hive_recipe_identity_crisis_casserole": {
    ...
    "description": "This casserole dish is a culinary enigma, crafted by the Changeling Hive Cooks. As you take your first bite, the flavor shifts unpredictably—once it might be rich with savory umami, and the next, sweet and fruity. The dish grants you advantage on Deception checks for 1 hour, making you feel unusually charismatic in conversation. However, it also forces you to forget your favorite food, leading to a memory lapse that imposes disadvantage on any check related to culinary knowledge or recalling tastes.",
    "price": 180,
    "icon": "📜",
    "stock": 5,
    "rarity": "uncommon",
    ...
    "effectDetails": [
      {
        ...
        "rules": "You gain advantage on all Deception checks for a duration of 1 hour. This effect ends if you use the ability, or when the duration expires."
      },
      {
        "title": "Memory Lapse",
        "rules": "For 24 hours after consuming this dish, you suffer disadvantage on any Intelligence (Investigation) check involving food memory and sensory recall. This effect is permanent until a short rest is taken."
      }
    ],
    "levelRequirementReason": "This recipe is simple enough for even the least experienced adventurers to enjoy.",
    "vendorReason": "The Changeling Hive Cooks are known for their innovative and whimsical dishes, constantly surprising their patrons with unique culinary experiences.",
    "shippingDetail": "Ships via Metamorphic Delivery, a courier service that ensures your dish arrives fresh and flavorful, delivered within three days of order placement.",
    "usage": {
      "activation": "Eating the entire casserole during a sitting.",
      "duration": "1 hour for Deceptive Advantage; permanent until a short rest is taken for Memory Lapse.",
      "endsWhen": "The duration ends or you take a short rest, whichever comes first.",
      "charges": "Unlimited uses"
    },
    "priceReason": "This dish's unique and temporary effects are balanced by its relatively simple preparation, making it accessible to all players.",
    "priceOriginal": 12500,
    "priceReviewedAt": "2026-07-22T00:46:33.685784+00:00",
    "aiReviewedAt": "2026-07-22T00:46:33.685784+00:00",
    "aiReviewVersion": 1
  },
  "changeling_hive_shape_shifter_sifter": {
    "id": "changeling_hive_shape_shifter_sifter",
    "name": "Changeling Hive Shape-Shifter Sifter",
    "description": "The Changeling Hive Shape-Shifter Sifter is a delicate, hexagonal device crafted from shimmering hive wax and enchanted by the Hive Toolmakers. When you use it to sift ingredients for jams, its mesh shifts fluidly to adapt to the size of the fruit or honeycomb pieces, ensuring that every batch is perfectly prepared. The sifter also subtly changes form when handling love essences, becoming a tender caress rather than a mechanical act; this adds advantage on checks for emotional recipes but may cause unpredictable results in less sentimental dishes.",
    "category": "equipment",
    "price": 180,
    "icon": "🍓",
    "stock": 5,
    "rarity": "uncommon",
    "effects": [
      "Adapts mesh size for optimal jamming",
      "Changes form for love essence handling"
    ],
    "vendor": "changeling_hive_nest",
    ...
    "effectDetails": [
      {
        "title": "Adaptive Sifting Mesh",
        "rules": "When you use this sifter to prepare jams, its hexagonal mesh shifts to match the size of the ingredients. This provides advantage on checks related to jam preparation but does not affect other tasks."
      },
      {
        "title": "Formal Love Handling",
        "rules": "The sifter's form subtly changes when handling love essences, becoming a tender caress rather than mechanical precision. While this adds advantage on emotional recipe checks, it may cause the sifter to shift unpredictably if used for other tasks."
      }
    ],
    "levelRequirementReason": "This item is suitable for beginners in culinary magic due to its straightforward and versatile mechanics.",
    "vendorReason": "The Hive Toolmakers specialize in crafting tools that enhance the natural world, making this sifter a perfect fit for their inventory.",
    "shippingDetail": "Ships via Adaptive Alloy with a 1-week processing time and free delivery to your door.",
    "usage": {
      "activation": "As an action during jamming or love essence preparation.",
      "duration": "Instantaneous",
      "endsWhen": "The recipe is completed or the sifter is no longer being used for these tasks.",
      "charges": "Unlimited uses"
    },
    "priceReason": "This price reflects a balanced value, considering its versatile utility and the rarity of materials used in its construction.",
    "priceOriginal": 7500,
    "priceReviewedAt": "2026-07-22T00:46:48.011415+00:00",
    "aiReviewedAt": "2026-07-22T00:46:48.011415+00:00",
    "aiReviewVersion": 1
  },
  "changeling_hive_shapeshift_scarf": {
    "id": "changeling_hive_shapeshift_scarf",
    "name": "Changeling Hive Shapeshift Scarf",
    "description": "This intricately woven scarf is a marvel of Hive Silkers' craftsmanship. It whispers and shifts with your surroundings, altering its hues to blend seamlessly into any environment. Should you overstay in one place, it begins to itch, granting you disadvantage on Concentration checks until you remove it. A testament to the changeling's ingenuity, this scarf is a must-have for those who wish to remain unseen but still command attention.",
    "price": 630,
    "icon": "🧣",
    "stock": 3,
    "rarity": "rare",
    ...
    "vendor": "changeling_hive_nest",
    "shippedBy": "Swift Wisp Courier",
    "levelRequirement": 2,
    "effectDetails": [
      {
        "title": "Facial Disguise Aid",
        "rules": "You gain advantage on Disguise checks for minor facial alterations when wearing the scarf. This effect is active as long as you are within a short range of at least one ally who can see both you and the target."
      },
      {
        "title": "Itchy Aftermath",
        "rules": "If worn continuously in one place for more than 1 hour, the scarf begins to itch. While it is itching, you have disadvantage on Concentration checks until the scarf is removed or cleaned."
      }
    ],
    "levelRequirementReason": "Requires a minimum level of 2 to ensure players can effectively use the scarf without overpowered effects.",
    "vendorReason": "The Hive Silkers are renowned for their skill in creating items that enhance disguise and stealth, making this scarf a natural addition to their offerings.",
    "shippingDetail": "Ships via the Swift Wisp Couriers who deliver with unmatched speed and precision.",
    "usage": {
      "activation": "Instantaneous; no activation required once worn",
      "duration": "Until removed or destroyed",
      "endsWhen": "Worn continuously for more than 1 hour in one place, or until removed",
      "charges": "Unlimited"
    },
    "priceReason": "The balanced price reflects the item's rarity and utility without being overpowered.",
    "priceOriginal": 18500,
    "priceReviewedAt": "2026-07-22T00:46:42.484774+00:00",
    "aiReviewedAt": "2026-07-22T00:46:42.484774+00:00",
    "aiReviewVersion": 1
  },
  "changeling_molt_cloak": {
    "id": "changeling_molt_cloak",
    "name": "Changeling Molt Cloak",
    "description": "Crafted from a changeling's molting skin, this cloak allows its wearer to perfectly mimic another humanoid. It captures not only the visual details but also the scent and texture of the target, making the wearer indistinguishable for hours on end. The cloak requires one hour to attune to a new form after acquiring it, and it can be worn by any character who has reached at least level 1.",
    "price": 17000,
    "icon": "🦎",
    "stock": 2,
    "rarity": "legendary",
    ...
    "effectDetails": [
      {
        ...
        "rules": "The wearer becomes indistinguishable from the target humanoid for up to 8 hours. This effect requires one hour of concentration to attune to a new target."
      },
      {
        "title": "Scent and Texture Capture",
        "rules": "The cloak captures the scent and texture of the target, making it difficult to distinguish the wearer through touch or smell alone. The mimicry ends if the wearer moves more than 30 feet away from the target or if the target is within 10 feet and actively checks."
      }
    ],
    "levelRequirementReason": "The cloak's attunement requires a concentration that only lower-level characters can sustain.",
    "vendorReason": "Only the changeling hive exchange knows the art of crafting such a delicate and powerful item, made from their own molting skin.",
    "shippingDetail": "Ships through the live specimen courier with no additional charge for handling.",
    "usage": {
      "activation": "One hour attunement period to switch targets.",
      "duration": "Up to 8 hours, depending on target and conditions.",
      "endsWhen": "Wearer moves more than 30 feet away from the target or if the target is within 10 feet and actively checks.",
      "charges": "Unlimited uses per day; attunement required for a new target."
    },
    "priceReason": "Balanced to allow low-level characters access while maintaining rarity value.",
    "priceOriginal": 55000,
    "priceReviewedAt": "2026-07-22T00:46:58.008423+00:00",
    "aiReviewedAt": "2026-07-22T00:46:58.008423+00:00",
    "aiReviewVersion": 1
  },
  "chaos_dwarfs_daemon_engine_tune_service": {
    ...
    "description": "This finely tuned engine core hums with the chaotic energy of a warforged forgeheart, its intricate gears and pistons whispering secrets of ancient dwarf craftsmanship. When installed in a construct, it grants +1 attack and damage for one day, but also introduces a risk of subtle chaos mutations—roll a d6 to determine: minor quirk (e.g., spontaneous singing or an extra arm). The engine's ominous purring sends shivers down the spine, a constant reminder of its volatile nature.",
    "price": 630,
    "icon": "⚙️",
    "stock": 3,
    "rarity": "rare",
    ...
    "effectDetails": [
      {
        "title": "Boosted Combat Capability",
        "rules": "When installed in a construct, the engine grants it an additional +1 to its attack and damage rolls for one day. This effect is instantaneous upon activation and lasts until the end of the next long rest."
      },
      {
        "title": "Chaos Mutation Risk",
        "rules": "There is a 20% chance (roll a d6; on a roll of 1-3) that the construct will gain a minor quirk, such as spontaneous singing or an extra arm. The effect lasts until the next long rest and does not require saving."
      }
    ],
    "levelRequirementReason": "The intricate tuning requires a good understanding of both dwarven engineering and chaotic energies.",
    "vendorReason": "Chaos Dwarfs Forge specializes in crafting items that harness the volatile powers of chaos, making this tune service a natural addition to their offerings.",
    "shippingDetail": "Ships with Hellbolt's signature 'chaos surge' package, which ensures the engine remains stable during transit.",
    "usage": {
      "activation": "Attuned construct must perform a short rest while the engineer and construct are in contact to activate.",
      "duration": "Instantaneous effect; lasts until next long rest.",
      "endsWhen": "Rest ends when the construct completes its next long rest.",
      "charges": "Unlimited, but requires attunement."
    },
    "priceReason": "The item's rarity and unique tuning process justify this balanced price point.",
    "priceOriginal": 16000,
    "priceReviewedAt": "2026-07-22T00:47:13.632766+00:00",
    "aiReviewedAt": "2026-07-22T00:47:13.632766+00:00",
    "aiReviewVersion": 1
  },
  "chaos_dwarfs_hell_bellows": {
    "id": "chaos_dwarfs_hell_bellows",
    "name": "Chaos Dwarfs Hell Bellows",
    "description": "The Chaos Dwarfs Hell Bellows are a pair of bellows forged in the heart of infernal forges, their metal warped and twisted by chaotic energies. These bellows can fuel unpredictable roasts with either searing heat or chilling cold, depending on the whims of chaos itself. Each use brings unpredictable results, granting advantage on rolls related to cooking but also risking a random effect that could enhance or sabotage your dish.",
    "category": "equipment",
    "price": 630,
    "icon": "🥩",
    "stock": 4,
    ...
    "effectDetails": [
      {
        "title": "Chaotic Cooking Advantage",
        "rules": "When you use the Hell Bellows to fuel a cooking attempt, you gain advantage on the roll. However, if the cooking is intended for an audience or requires precision, there's a 25% chance (DC 14 Dexterity save) that it will go awry."
      },
      {
        "title": "Random Heat (Boon or Bane)",
        "rules": "Each use of the Hell Bellows has a 50% chance to apply either a boon or a bane. A boon could be an unexpected burst of heat, enhancing your dish's quality by +1d4 flavor points; conversely, a bane might cause the food to spoil or become inedible."
      }
    ],
    "levelRequirementReason": "The Hell Bellows require a certain finesse and understanding of chaotic energies that only comes with experience.",
    "vendorReason": "As these bellows are forged in the Chaos Dwarfs' infernal forges, it's no surprise they sell items imbued with their unique magic.",
    "shippingDetail": "Ships directly from the forge, arriving hot and ready to use. Expect a delay of one week due to the volatile nature of the item.",
    "usage": {
      "activation": "As an action when starting to cook with charcoal or wood fuel.",
      "duration": "Instantaneous effect; lasts until your next turn.",
      "endsWhen": "The cooking attempt is completed, and it can be used again after a short rest.",
      "charges": "Unlimited uses per long rest"
    },
    "priceReason": "Crafted from rare materials and infused with chaotic energies, the Hell Bellows are highly sought after for their unpredictable yet potent cooking abilities.",
    "priceOriginal": 7500,
    "priceReviewedAt": "2026-07-22T00:47:38.882753+00:00",
    "aiReviewedAt": "2026-07-22T00:47:38.882753+00:00",
    "aiReviewVersion": 1
  },
  "chaos_dwarfs_hellfire_roast_recipe": {
    "id": "chaos_dwarfs_hellfire_roast_recipe",
    "name": "Recipe: Chaos Dwarfs Hellfire Roast",
    "description": "The Recipe: Chaos Dwarfs Hellfire Roast instructs you to roast meat over infernal flames, imbuing it with chaotic energy that stirs both wonder and dread. The result is a savory yet unpredictable dish that can either grant you a +1 increase in a random stat for two hours or subject you to an equally random but potentially malevolent effect. Only the bravest souls dare partake of this fiery feast, knowing full well the gods of chaos themselves have blessed it.",
    "price": 630,
    "icon": "🥩",
    "stock": 4,
    "rarity": "rare",
    ...
    "effectDetails": [
      {
        "title": "Random Mutation Boon",
        "rules": "Eating the dish grants a +1 increase in a randomly selected ability score for two hours. There is no way to predict which stat will be affected."
      },
      {
        "title": "Random Mutation Bane",
        "rules": "Alternatively, consuming this meal could trigger an unpredictable negative effect, such as a temporary hit point drain or a random ability penalty lasting for the same duration."
      }
    ],
    "levelRequirementReason": "The unpredictable nature of the dish makes it unsuitable for lower-level characters who might not handle its chaotic effects well.",
    "vendorReason": "As Hellforge Cooks, they have mastered the art of creating dishes that satisfy even the most insatiable appetites for chaos and power.",
    "shippingDetail": "The roast is delivered still sizzling hot, ensuring its potency remains intact until consumption.",
    "usage": {
      "activation": "Cooking and eating the dish",
      "duration": "Instantaneous effect upon consumption; lasts for two hours",
      "endsWhen": "Effect ends after two hours or if the consumer stops benefiting from it early",
      "charges": "Unlimited"
    },
    "priceReason": "The dish requires rare ingredients and precise preparation, making it a valuable yet not excessively overpriced item for those willing to take the risk.",
    "priceOriginal": 8500,
    "priceReviewedAt": "2026-07-22T00:47:38.619109+00:00",
    "aiReviewedAt": "2026-07-22T00:47:38.619109+00:00",
    "aiReviewVersion": 1
  },
  "chaos_dwarfs_hellforged_leather": {
    "id": "chaos_dwarfs_hellforged_leather",
    "name": "Chaos Dwarfs Hellforged Leather",
    "description": "The Chaos Dwarfs Hellforged Leather is crafted from the hides of infernal beasts, forged in the fiery depths where chaos and order clash. Its surface crackles faintly as it releases a steady warmth, making it both uncomfortable to wear in the summer heat and invaluable for those who face fire and chaos. This armor not only enhances its wearer’s resilience against these elemental threats but also grants a sense of empowerment derived from its infernal origins.",
    "price": 630,
    "icon": "🧥",
    "stock": 2,
    "rarity": "rare",
    "effects": [
      "+1 AC vs Fire or Chaos",
    ...
    "effectDetails": [
      {
        ...
        "rules": "While wearing this armor, the wearer is immune to the discomfort of moderate heat. However, it emits a steady warmth that can be intolerable in excessively hot climates."
      },
      {
        "title": "Armor Durability",
        "rules": "This leather armor has an innate resistance to tearing and puncturing damage, making it highly durable against sharp weapons."
      }
    ],
    "levelRequirementReason": "Even the simplest warrior can benefit from its protection against chaotic and fiery dangers.",
    "vendorReason": "The Chaos Dwarfs Anvil specializes in crafting weapons and armor from infernal materials, making this leather a staple of their offerings.",
    "shippingDetail": "Delivered via swift courier, ensuring the armor arrives in pristine condition.",
    "usage": {
      "activation": "Passive effect",
      "duration": "Instantaneous",
      "endsWhen": "Destroyed by fire or exposed to a chaotic creature's touch",
      "charges": "Unlimited"
    },
    "priceReason": "Balanced at this price point, the Hellforged Leather provides significant protection and is a reasonable investment for any adventurer facing elemental threats.",
    "priceOriginal": 20000,
    "priceReviewedAt": "2026-07-22T00:48:01.163872+00:00",
    "aiReviewedAt": "2026-07-22T00:48:01.163872+00:00",
    "aiReviewVersion": 1
  },
  "chaos_heart": {
    "id": "chaos_heart",
    "name": "The Chaos Heart",
    "description": "The Chaos Heart, a pulsating black orb that hums with malevolent energy, is said to have been forged from the molten remains of shattered realities. It can consume worlds and open rifts to other dimensions, banishing foes into realms beyond existence. However, its dark magic comes at a terrible cost: anyone who wields it slowly loses their soul to the Void, causing the universe itself to wither around them. The heart's power is so immense that improper use will tear apart the fabric of reality and end the campaign for good.",
    "category": "forbidden",
    "price": 170000,
    "icon": "🖤",
    "stock": 1,
    "rarity": "godly",
    "effects": [
      "Opens Void rifts (banish enemies to non-existence)",
      "Grants invulnerability when pierced by a Pure Heart"
    ],
    "vendor": "onyx_hand",
    ...
    "effectDetails": [
      {
        "title": "Void Rift",
        "rules": "The user can open a rift, banishing one creature of their choice within 30 feet to the Void. The target must succeed on a DC 25 Wisdom saving throw or be sent to a dimension beyond existence, ceasing to exist in the material plane for 1d6 rounds."
      },
      {
        "title": "Invulnerability",
        "rules": "The user gains resistance to all damage from attacks. This effect persists until the user is hit by an attack made with a Pure Heart or similar item that specifically targets this ability, at which point it immediately ends and the user takes full damage."
      }
    ],
    "levelRequirementReason": "Only those of sufficient power can handle such dark magic without succumbing to its corruption.",
    "vendorReason": "The Onyx Hand has a long-standing partnership with entities from the Void, and they are known for dealing in forbidden artifacts like this one.",
    "shippingDetail": "Delivery is instantaneous via rift travel. However, there's a 5% chance that the item will be sent to the wrong dimension upon arrival.",
    "usage": {
      "activation": "A bonus action to open a rift or use invulnerability.",
      "duration": "Instantaneous for rifts; invulnerability lasts until hit by a piercing attack with a Pure Heart.",
      "endsWhen": "Invulnerability ends when the user is pierced, and the rift closes after 1d6 rounds. The item cannot be used again until recharged through a lengthy ritual.",
      "charges": "Unlimited, but only one use per day."
    },
    "priceReason": "The Chaos Heart's price is set at 1000 XP, reflecting its immense power and the risk it poses to any who wield it. Its rarity and danger justify this cost.",
    "priceOriginal": 1500000,
    "priceReviewedAt": "2026-07-22T00:47:57.369679+00:00",
    "aiReviewedAt": "2026-07-22T00:47:57.369679+00:00",
    "aiReviewVersion": 1
  },
  "chaos_heart_shard": {
    "id": "chaos_heart_shard",
    "name": "Shard of the Chaos Heart",
    "description": "A fragment of the Chaos Heart, this shard glows with unstable energies and whispers of cosmic anarchy. Crafted in the forges of the Cosmic Jesters, it is said to have been forged from the very fabric of reality itself. Handling this shard grants a chaotic advantage to all your Chaos-based spells, but also leaves you vulnerable to Order's backlash, compelling you to roll a saving throw against such effects.",
    "category": "forbidden",
    "price": 17000,
    "icon": "💜",
    "stock": 1,
    ...
    "effectDetails": [
      {
        ...
        "rules": "When using a spell of the Chaos descriptor, you gain advantage on all attack and damage rolls. This effect lasts until the start of your next turn."
      },
      {
        "title": "Orderly Vulnerability",
        "rules": "For every hour you wield this shard without succumbing to Order's backlash, you must make a DC 17 Constitution saving throw or suffer disadvantage on all saving throws against effects with the Order descriptor. This effect ends when you successfully save."
      }
    ],
    "levelRequirementReason": "This relic is too powerful for lower-level characters and requires a certain mastery of Chaos-based magic to wield effectively.",
    "vendorReason": "The Cosmic Jesters, creators of the shard, are known to trade its fragments through their black market as they seek to spread chaos across the multiverse.",
    "shippingDetail": "Pickup is available only in a dimensionally secure location within the Cosmic Jesters' domain. Shipping directly from this realm can lead to dimensional breaches if not handled properly.",
    "usage": {
      "activation": "Passive effect when wielding the shard, no activation required.",
      "duration": "Until start of your next turn or until you succumb to Order's backlash.",
      "endsWhen": "You successfully save against Order-based effects or after one hour without saving.",
      "charges": "Unlimited"
    },
    "priceReason": "The shard is a balance between chaotic power and its potential for chaos, making it a valuable yet reasonably priced item for those who can handle such power.",
    "priceOriginal": 750000,
    "priceReviewedAt": "2026-07-22T00:48:17.739845+00:00",
    "aiReviewedAt": "2026-07-22T00:48:17.739845+00:00",
    "aiReviewVersion": 1
  },
  "cheep_cheep_aquarium": {
    "id": "cheep_cheep_aquarium",
    "name": "Portable Cheep-Cheep Tank",
    "description": "The Portable Cheep-Cheep Tank is a glass sphere no larger than a clenched fist, containing a vibrant blue cheep-cheep fish that thrives in its miniature aquarium. Crafted by the Comet Observatory, this tank allows you to breathe underwater when holding it and grants you a water jet of crisp ocean spray as long as you maintain your concentration. The cheep-cheep sings melodic sea shanties that can lift the spirits of even the most weary sailor.",
    "category": "equipment",
    "price": 630,
    "icon": "🐟",
    "stock": 3,
    ...
    "vendor": "comet_observatory",
    "shippedBy": "Sea-Spider Messenger Fleet",
    "levelRequirement": 1,
    "effectDetails": [
      {
        "title": "Breathe Underwater",
        "rules": "While holding this tank, you are considered to be breathing normally underwater. This effect lasts for a short rest and can only be used once per long rest."
      },
      {
        "title": "Water Jet",
        "rules": "As an action, you may command the tank to shoot a jet of water in a 15-foot line. The jet deals 2d6 bludgeoning damage and has a range of 30 feet. Concentration is required while using this effect; if broken or lost, the cheep-cheep becomes hostile."
      }
    ],
    "levelRequirementReason": "The Portable Cheep-Cheep Tank is accessible to adventurers who are just beginning their journeys and can benefit from its unique abilities.",
    "vendorReason": "The Comet Observatory specializes in aquatic curiosities and has the expertise to craft such a remarkable item.",
    "shippingDetail": "Delivered via the Sea-Spider Messenger Fleet, ensuring safe passage through treacherous waters. Expect delivery within one week of purchase.",
    "usage": {
      "activation": "Action or Bonus Action (Water Jet)",
      "duration": "Instantaneous (Water Jet); lasts for a short rest (Breathe Underwater)",
      "endsWhen": "Lost, destroyed, or concentration is broken",
      "charges": "Unlimited, but requires concentration"
    },
    "priceReason": "The Portable Cheep-Cheep Tank is priced at 1000 XP as it combines the utility of underwater breathing with a unique water jet attack, offering both survival and combat advantages.",
    "priceOriginal": 11000,
    "priceReviewedAt": "2026-07-22T00:48:18.717728+00:00",
    "aiReviewedAt": "2026-07-22T00:48:18.717728+00:00",
    "aiReviewVersion": 1
  },
  "cheep_cheep_life_preserver": {
    "id": "cheep_cheep_life_preserver",
    "name": "Cheep Cheep Life Preserver",
    "description": "The Cheep Cheep Life Preserver is a whimsical device, resembling a silver and blue fish with operatic gills. Crafted in the depths by artisans of aquatic opera, it keeps you afloat even underwater while emitting a hauntingly beautiful soprano solo that echoes through the sea. Though its music drowns out stealth, it also draws curious (and sometimes dangerous) creatures closer, making this a double-edged boon for those in perilous watery realms.",
    "category": "equipment",
    "price": 630,
    "icon": "🐠",
    "stock": 4,
    ...
    "effectDetails": [
      {
        "title": "Cannot Drown",
        "rules": "While wearing the Cheep Cheep Life Preserver, you are immune to drowning. You cannot be knocked prone or suffer from suffocation underwater."
      },
      {
        "title": "Attracts Aquatic Predators",
        "rules": "When submerged in water for more than 1 minute, you must make a Wisdom saving throw (DC 12). On a failed save, one hostile fish of your choice within 30 feet appears adjacent to you. This effect can be triggered once per long rest."
      }
    ],
    "levelRequirementReason": "This device is designed for adventurers just starting their aquatic journeys, providing them with basic protection and a unique feature.",
    "vendorReason": "The Valley Trading Post specializes in exotic goods from various realms, including the rare and whimsical items crafted by sea opera artisans.",
    "shippingDetail": "Ships via a floating crate that navigates the waterways, arriving within one week of purchase.",
    "usage": {
      "activation": "Passive effect; no activation required.",
      "duration": "Instantaneous; lasts until removed or destroyed.",
      "endsWhen": "Destroyed by damage exceeding your hit points or when removed from you.",
      "charges": "Unlimited, recharged at dawn."
    },
    "priceReason": "The Cheep Cheep Life Preserver is priced moderately to reflect its unique utility and the specialized craftsmanship required for its creation.",
    "priceOriginal": 15000,
    "priceReviewedAt": "2026-07-22T00:48:35.713416+00:00",
    "aiReviewedAt": "2026-07-22T00:48:35.713416+00:00",
    "aiReviewVersion": 1
  },
  "cheep_cheep_net": {
    "id": "cheep_cheep_net",
    "name": "Cheep Cheep Net",
    "description": "The Cheep Cheep Net is a delicate, intricately woven net made from the silken threads of underwater spiders and enchanted to catch both fish and flying foes. Crafted by the merfolk of the Deepwood Lagoon, this net glows faintly with an otherworldly blue light, making it especially effective in dim waters. It can be used to ensnare aquatic creatures (yielding 1d4 fish per use) or entangle flying enemies, restraining them until they succeed on a Strength saving throw (DC 15). The net is both durable and versatile, requiring only five uses before needing repair.",
    "category": "equipment",
    "price": 180,
    "icon": "🕸️",
    "stock": 8,
    ...
    "effectDetails": [
      {
        "title": "Aquatic Catcher",
        "rules": "The Cheep Cheep Net can be used as a fishing tool. On a successful DC 15 Wisdom (Nature) check, the net catches 1d4 fish per use within reach. This effect is instantaneous."
      },
      {
        "title": "Flying Entangler",
        "rules": "When used against flying creatures or enemies with wings, the Cheep Cheep Net can restrain them for one minute. The target must succeed on a Strength saving throw (DC 15) to escape this effect. This use of the net expends one charge."
      }
    ],
    "levelRequirementReason": "Adept swimmers and beginners alike find this tool useful in their quests.",
    "vendorReason": "The Valley Trading Post often stocks items that are practical for adventurers of all levels, making the Cheep Cheep Net an easy addition to their inventory.",
    "shippingDetail": "This item is shipped rolled up in its protective case and can be used immediately upon arrival.",
    "usage": {
      "activation": "Action",
      "duration": "Instantaneous (Aquatic Catcher) or one minute (Flying Entangler)",
      "endsWhen": "The target escapes the Flying Entangler effect, or all charges are expended",
      "charges": "5 uses before repair"
    },
    "priceReason": "Balanced at this price for its utility and durability, making it a worthwhile investment for any adventurer.",
    "priceOriginal": 6000,
    "priceReviewedAt": "2026-07-22T00:48:36.319702+00:00",
    "aiReviewedAt": "2026-07-22T00:48:36.319702+00:00",
    "aiReviewVersion": 1
  },
  "chet_rippo_service": {
    "id": "chet_rippo_service",
    "name": "Stat Reallocation",
    "description": "Pauline's Microphone allows you to reallocate your stat points for a fleeting moment, reshaping your character’s potential. With a crisp exhale into its polished surface, two points from any stat are temporarily transferred to another, but the microphone hums with power that can only be used once per day. The core of this device is forged in the heart of a volcano, imbued with volcanic essence for unparalleled strength.",
    "category": "services",
    "price": 630,
    "icon": "🧙‍♂️",
    "stock": 1,
    "rarity": "rare",
    "effects": [
      "Temporarily reallocate 2 stat points",
      "Limited daily use"
    ],
    "vendor": "rogueport_black_market",
    "shippedBy": "In Person",
    ...
    "effectDetails": [
      {
        ...
        "rules": "Activate as an action. You can temporarily transfer two points from any one of your ability scores to another, but you cannot exceed a total of 20 in any stat. This effect lasts for the rest of the day and can be used once per day."
      },
      {
        "title": "Daily Limit",
        "rules": "Once per day at dawn, you may use Pauline's Microphone to reallocate your stats. This is a one-time daily use only."
      }
    ],
    "levelRequirementReason": "This item requires no specific level as it offers a temporary boost rather than a permanent change.",
    "vendorReason": "The Rogue Port Black Market is known for offering unique and rare items that can alter the course of one’s adventure, making Pauline's Microphone an ideal fit.",
    "shippingDetail": "Delivered directly by a trusted courier, ensuring your privacy and security.",
    "usage": {
      "activation": "Action",
      "duration": "Until the end of the day",
      "endsWhen": "At dawn the next day",
      "charges": "Daily"
    },
    "priceReason": "This item offers a powerful and temporary boost, making it worth 1000 XP but ensuring it remains balanced within the game economy.",
    "priceOriginal": 100000,
    "priceReviewedAt": "2026-07-22T00:51:11.139248+00:00",
    "aiReviewedAt": "2026-07-22T00:51:11.139248+00:00",
    "aiReviewVersion": 1
  },
  "chomp_call_whistle": {
    "id": "chomp_call_whistle",
    "name": "Chain Chomp Call",
    "description": "This tarnished whistle is known to summon a Chain Chomp, a ferocious beast of the wilds. Its call echoes through the forest, and within moments, the chomp's jaws snap into view, eager to obey its master's command. However, there's a chance it might mistake you for prey and attack instead. Once summoned, the chomp leaves after a minute or when it grows bored, leaving behind an eerie silence.",
    "category": "consumables",
    "price": 630,
    "icon": "📯",
    "stock": 4,
    ...
    "effectDetails": [
      {
        "title": "Chain Chomp Summoning",
        "rules": "As an action, you can activate this whistle to summon a CR 2 Chain Chomp. The chomp remains for 1 minute or until it becomes bored and leaves on its own."
      },
      {
        "title": "50% Attack Chance",
        "rules": "There is a 50% chance that the summoned Chain Chomp will attack you instead of moving to your target. This effect lasts for the duration of the chomp's presence."
      }
    ],
    "levelRequirementReason": "This whistle requires little skill, but it can still be dangerous and should not be underestimated.",
    "vendorReason": "The traders at Valley Trading Post often have unusual items that travelers need for their journeys.",
    "shippingDetail": "Shipped by Swift Wind Courier, known for its reliable service and quick delivery.",
    "usage": {
      "activation": "Action",
      "duration": "1 minute per use",
      "endsWhen": "The chomp leaves or becomes bored",
      "charges": "Unlimited uses"
    },
    "priceReason": "The price reflects the item's rarity and utility, making it a valuable but not overpowered addition to any adventurer's arsenal.",
    "priceOriginal": 15000,
    "priceReviewedAt": "2026-07-22T00:48:46.395487+00:00",
    "aiReviewedAt": "2026-07-22T00:48:46.395487+00:00",
    "aiReviewVersion": 1
  }
};
