...
export const ITEMS_053 = {
    ...
    'connectopia_chronometric_shard': {
        id: 'connectopia_chronometric_shard',
        name: "Temporal Echo Fragment",
        description: "A shimmering fragment of solidified time. Hold it close and you might experience a fleeting memory... or just feel a slight headache. Don't stare too long, or you’ll end up stuck in yesterday!",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 6500,
        icon: '⏳',
        stock: 12,
        ...
        stockType: 'limited_daily',
        effects: [
            "chance_to_rewind_time_10%",
            "increased_perception_5"
        ],
        vendor: 'pioneer_post',
        shippedBy: 'Time Runner',
        levelRequirement: 8
    },
    ...
    'the_edge_whispering_shard': {
        id: 'the_edge_whispering_shard',
        name: "Echoes of the Void",
        description: "This pulsating shard seems to whisper fragments of forgotten realities, offering glimpses into impossible dimensions. Holding it briefly grants a minor bonus to perception and resistance against fear effects – but prolonged exposure might drive you mad!",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 18000,
        icon: '🔮',
        stock: 5,
        ...
        stockType: 'limited_daily',
        effects: [
            "perception +2 for 3 rounds",
            "resistance to fear effects for 2 rounds",
    ...
    'earth_land_dragonscale_shard': {
        id: 'earth_land_dragonscale_shard',
        name: "Fragment of the Frost Wyrm's Hide",
        description: "A jagged piece of shimmering ice-blue scale, said to have fallen from a young frost dragon. It radiates a chilling aura and seems to… vibrate with ancient power! Perfect for adding a touch of frosty elegance (and maybe freezing your enemies).",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 7500,
        icon: '🧊',
        stock: 12,
        ...
        stockType: 'limited_daily',
        effects: [
            "armor_defense_increase_3",
            "resistance_to_cold_50%"
        ],
        vendor: 'magic_shop',
        shippedBy: 'flying_carpet',
        levelRequirement: 12
    ...
    'middle_earth_dwarven_battle_axe': {
        id: 'middle_earth_dwarven_battle_axe',
        name: "Grimstone's Stubborn Cleaver",
        description: "Forged in the depths of Khazad-dûm, this battle axe looks like it’s seen a few goblin skirmishes (and maybe a dragon or two!). It’ll cleave through armor like butter... or at least make a satisfying thwack.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 7500,
        icon: '⚔️',
        stock: 12,
        ...
        effects: [
            "increases_strength",
            "chance_to_cripple",
            "adds_critical_damage"
        ],
        vendor: 'dwarven_forge',
        shippedBy: 'giant_carrier_beetle',
        levelRequirement: 10
    },
