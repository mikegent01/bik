// Shop items chunk 12 of 51
// Items 1101 to 1200 (100 items)
...
export const ITEMS_012 = {
  ...
  'existence_absorption_staff': {
    ...
    description: "A staff that absorbs the existence of anything it touches.",
    ...
    rarity: 'godly',
    effects: [
        "Touch anything: absorb its entire existence (it never existed)",
        "Gain all its powers, memories, and stats permanently",
        "Made by: The Devourer"
    ],
  ...
  'existence_debt_collector': {
    ...
    description: "Collects debts from beings that owe you their existence.",
    category: SHOP_CATEGORIES.SERVICES,
    price: 65000000,
    icon: '💰',
    stock: 1,
    rarity: 'godly',
    effects: [
        "Any being you created or saved owes you a debt of existence (they must obey one command)",
        "Can call in debts from across the multiverse",
  ...
  'existence_insurance_policy': {
    ...
    description: "If you cease to exist, you get a full refund plus a new existence.",
    category: SHOP_CATEGORIES.SERVICES,
    price: 80000000,
    icon: '🛡️',
    stock: 1,
    rarity: 'godly',
    effects: [
        "If erased from existence, you automatically come back with 2x your previous power",
        "Can claim the policy once per campaign",
        "Made by: The Insurance Adjuster"
    ],
    vendor: 'existence_insurance',
    shippedBy: 'Reincarnation',
    levelRequirement: 90
},
  ...
  'exponential_growth_coin': {
    ...
    description: "A coin that doubles itself every second.",
    ...
    rarity: 'godly',
    effects: [
        "Place it in your vault: doubles all gold in vault every day (exponential growth)",
        "After 30 days, you have more gold than atoms in the universe (breaks economy)",
  ...
  'faerun_blighted_bell': {
        ...
        description: "A cracked bronze bell that rings with the sound of forgotten curses. When struck, it emits a pulse that slows nearby enemies by 10% for 1 round.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2800,
        icon: '📦',
        stock: 2,
        ...
        "Can be used as a summoning bell for minor curses (once per day)"
        ],
        vendor: 'faerun',
  ...
  'faerun_blooded_horn_of_zeal': {
        ...
        description: "A relic forged from the horn of a slain dragon and the blood of a sacred warlord. Emits a resonant cry that disrupts enemy morale and amplifies allies’ courage. Only usable by those who have faced death in battle.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🐉',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Boosts morale of nearby allies by 25% for 2 minutes",
        "Inflicts -10% morale on enemies within 10 meters",
        "Requires a battle cry to activate (30-second cooldown)"
        ],
        vendor: 'faerun',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
  ...
  'faerun_bloodstone_amulet': {
        ...
        description: "Worn by the brave and the broken, this amulet channels the last pulse of a slain dragon. It grants resilience against magical damage and awakens a latent sense of courage in the wearer when facing overwhelming odds.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '📦',
        stock: 2,
        ...
        "Grants +2 to morale checks when facing fear or despair",
        "Increases chance to resist fear effects by 50%"
        ],
        vendor: 'faerun',
  ...
  'faerun_echo_gauntlet': {
        ...
        description: "A gauntlet forged from the bones of a fallen archon, now resonating with echoes of past battles. When used, it allows the wearer to hear the thoughts of nearby allies for 10 seconds.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 5000,
        icon: '🎭',
        stock: 1,
        rarity: 'epic',
        effects: [
            "Grants +1 to Perception checks for 10 seconds",
        "Allows hearing of nearby allies’ thoughts (no speech)",
        "Grants 100 XP on successful combat maneuver"
        ],
        vendor: 'faerun',
  ...
  'faerun_echo_helm': {
        ...
        description: "A heavy, resonant helm that echoes the voices of forgotten battles. Wears the user with a faint hum of memory, granting temporary resistance to mind-affecting spells.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2800,
        icon: '🔮',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Grants +1 to Will saves against charm and mind control",
        "Wearer gains +1 to AC against spellcasters",
        "Upon activation, the helm emits a low hum that can be used to disorient enemies for 1 round"
        ],
        vendor: 'faerun',
        shippedBy: 'Koopa Postal',
        levelRequirement: 5
  ...
  'faerun_echo_of_the_wolf': {
        ...
        description: "A cursed amulet that echoes the howls of the lost, granting the wearer the ability to hear the thoughts of nearby undead or cursed beasts. A dangerous tool for both hunters and scholars.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 2500,
        icon: '🐺',
        stock: 1,
        rarity: 'rare',
        effects: [
            "Grants perception of undead thoughts for 1 minute",
        "Reveals hidden traps or cursed paths",
        "Causes minor madness if used against living foes"
        ],
        vendor: 'faerun',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
  ...
  'faerun_ember_satchel': {
        ...
        description: "A leather pouch stitched with molten thread from a defunct fire temple. When opened, it emits a warm, glowing ember that can be used to light torches or ignite magical flames.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 1200,
        icon: '🔥',
        stock: 5,
        rarity: 'uncommon',
        effects: [
            "Grants +1 to AC for 1 round when used to light a torch",
        "Restores 10 HP when used to ignite a magical flame",
        "Can be used to light 2 torches in one round"
        ],
        vendor: 'faerun',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 4
  ...
  'faerun_ember_scarf': {
        ...
        description: "Woven from the remnants of a fallen dragon’s fire, this scarf radiates heat and shields the wearer from frosty colds. Its glow dims with fear, warning of impending danger.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        "Grants a 10% bonus to fire-based attacks"
        ],
        vendor: 'faerun',
        shippedBy: 'Shy Guy Smugglers',
        levelRequirement: 5
  ...
  'faerun_feywild_bloodstone': {
        ...
        description: "A pulsating crystal that pulses with the heartbeat of the Feywild. Worn near the heart, it grants the wearer a temporary connection to the fey realms—allowing them to perceive magical echoes and navigate enchanted paths.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        "Can be used to identify hidden fey constructs or illusions"
        ],
        vendor: 'faerun',
  ...
  'faerun_forged_gauntlet': {
        ...
        description: "A blackened iron gauntlet forged from the remnants of a fallen warlord. It deals extra damage to undead and grants a +1 bonus to Strength checks against creatures with a fear trait.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3500,
        icon: '📦',
        stock: 1,
        ...
        "Wearer cannot be frightened by non-magical fear effects"
        ],
        vendor: 'faerun',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
  ...
  'faerun_greenskin_satchel': {
        ...
        description: "A moss-woven satchel that pulses with the heartbeat of the forest. It absorbs poison and venom, and when used in combat, triggers a temporary camouflage effect.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2000,
        icon: '🌿',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Absorbs 1d4 poison damage per use",
        "Grants 20% chance to evade detection for 1 round",
        "Wearer gains +2 to Stealth checks while in woodland terrain"
        ],
        vendor: 'faerun',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
  ...
  'faerun_item_name': {
        ...
        description: "This helmet echoes with the voice of a once-kingly spirit, granting the wearer the ability to hear the thoughts of all who have died within the last 100 years. It is heavy, cold, and slightly metallic to the touch.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 4000,
        icon: '📦',
        stock: 1,
        rarity: 'rare',
        effects: [
            "Grants +2 to Wisdom checks to detect hidden truths",
        "Can hear the thoughts of any deceased being within 100ft",
        "Wears off after 1 hour of continuous use"
        ],
        vendor: 'faerun',
        shippedBy: 'Lakitu Drones',
        levelRequirement: 5
  ...
  'faerun_mage_soul_ember': {
        ...
        description: "A glowing, crystalline shard infused with the essence of a fallen wizard. When held, it grants temporary spellcasting power and dims ambient magical backlash. Ideal for mages in combat zones.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Grants +10% spellcasting efficiency for 10 minutes",
        "Reduces magical backlash by 50% for 30 seconds",
        "Can be recharged with 30 seconds of rest"
        ],
        vendor: 'faerun',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
  ...
  'faerun_moonshard_sword': {
        ...
        description: "A slender blade forged from moonlight and the tears of a lost moon-spirit. Glows faintly at night and deals extra damage to illusions and phantoms.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 4000,
        icon: '📦',
        stock: 1,
        rarity: 'rare',
        effects: [
            "Deals +1 damage to illusions and phantoms",
        "Grants +2 to Stealth checks while holding",
        "When used to strike an illusion, the target is momentarily confused for 1 round"
        ],
        vendor: 'faerun',
        shippedBy: 'Koopa Postal',
        levelRequirement: 5
  ...
  'faerun_moonstone_amulet': {
        ...
        description: "A cold, crystalline amulet that reveals hidden paths and echoes the voices of the lost. Worn by those who seek the truth beneath the veil.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Reveals hidden doors or secret passages",
        "+5% chance to detect invisible foes",
        "Grants temporary invisibility for 1 round when activated"
        ],
        vendor: 'faerun',
        shippedBy: 'Shy Guy Smugglers',
        levelRequirement: 5
  ...
  'faerun_raveneye_gloves': {
        ...
        description: "These gloves are imbued with the eyes of ravens that once watched over the shattered halls of Raventree Manor. They allow the wearer to perceive the unseen—revealing hidden passages, traps, and magical wards hidden in plain sight.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Reveals hidden magical wards or traps within 10 feet",
        "+15% chance to dodge magical projectiles or spells",
        "Grants temporary “vision of shadows” when entering darkened rooms"
        ],
        vendor: 'faerun',
        shippedBy: 'Rakasha Spirit Walk',
        levelRequirement: 5
  ...
  'faerun_rune_inkwell': {
        ...
        description: "An obsidian inkwell filled with ink that writes runes as you think them. Perfect for spellcasters who need to inscribe incantations mid-battle.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 3000,
        icon: '📜',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Allows casting of 1 spell per inkwell use (requires 1 minute to write)",
        "Grants +1 to spellcasting DC for 1 round",
        "Can be used to inscribe up to 3 spells at once"
        ],
        vendor: 'faerun',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 6
  ...
  'faerun_scarlet_blade': {
        ...
        description: "A cursed dagger that glows with the blood of fallen heroes. Its edge shatters on contact with undead, but its wielder suffers 2d4 damage each time it strikes a living foe.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        "Wielder takes 2d4 damage per strike on living targets",
        "Inflicts “Cursed Mark” on targets for 1 round, reducing their next action"
        ],
        vendor: 'faerun',
        shippedBy: 'Shy Guy Smugglers',
        levelRequirement: 5
