...
export const ITEMS_055 = {
    ...
    'faerun_item_rusty_dragon_scale': {
        id: 'faerun_item_rusty_dragon_scale',
        name: "Rusty Dragon Scale Shield",
        description: "This scale, plucked from the remains of a surprisingly small (and probably grumpy) dragon, radiates a faint warmth. It's covered in rust, but it still provides decent protection – mostly against disappointment.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3500,
        icon: '🛡️',
        stock: 67,
    ...
    'the_edge_chronal_crumbs': {
        id: 'the_edge_chronal_crumbs',
        name: "Chronal Crumbs",
        description: "Collected from the shattered remnants of time itself, these shimmering crumbs grant a fleeting glimpse into potential futures. Just don’t eat too many – you might end up as a sentient pineapple.",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 750,
        icon: '⏳',
        stock: 25,
    ...
    'connectopia_echoing_shard': {
        id: 'connectopia_echoing_shard',
        name: "Echoing Shard of Resonance",
        description: "A fragment pulled from a shattered connection node, this shimmering shard pulses with residual energy. Holding it allows you to briefly amplify sounds – useful for detecting hidden passages or confusing your enemies with disorienting echoes! Don't get too lost in the noise though.",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 850,
        icon: '🔊',
        stock: 35,
        ...
        stockType: 'limited_daily',
        effects: [
            "detects hidden passages within a 10-meter radius",
            "chance to confuse enemy creatures (10%)",
            "provides +2 to perception checks"
        ],
        vendor: 'pioneer_post',
