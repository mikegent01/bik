...
export const ITEMS_061 = {
    ...
    'internet_data_spike': {
        id: 'internet_data_spike',
        name: "Viral Velocity Injector",
        description: "This shimmering data spike is packed with concentrated memes! Inject it into your character for a burst of speed and temporary viral influence – watch those enemies fall like dominoes!",
        ...
        effects: [
            "increase_speed_x2_for_10_seconds",
            "chance_to_spread_confusion_on_target",
            "temporary_buff_charisma_x1.5"
        ],
        vendor: 'data_dealer',
    ...
    'the_edge_shard_whisper': {
        id: 'the_edge_shard_whisper',
        name: "Echoing Void Shard",
        description: "This jagged fragment pulses with the faint whispers of forgotten realities – a chilling reminder that even echoes can carry madness. Holding it grants glimpses of impossible geometries, potentially driving you to question your sanity… or find a really good shortcut!",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 1800,
        icon: '🔮',
        stock: 25,
        ...
        stockType: 'limited_daily',
        effects: [
            "grant temporary madness (1d6)",
            "chance to reveal hidden paths",
            "increased perception for one round"
        ],
        vendor: 'abyss_trader',
    ...
    'the_edge_shard_of_echoes': {
        id: 'the_edge_shard_of_echoes',
        name: "Echoing Void Fragment",
        description: "A jagged piece ripped from the abyss itself! Holding this shard causes faint whispers of forgotten realities to swirl around you, potentially granting a moment of precognition or driving you utterly mad – your call!",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 1800,
        icon: '🔮',
        stock: 25,
        ...
        stockType: 'limited_daily',
        effects: [
            "chance to grant precognition (1%)",
            "chance to cause temporary madness (-3 to INT)",
    ...
    'connectopia_artifact_of_the_great_blocker': {
        id: 'connectopia_artifact_of_the_great_blocker',
        name: "The Nullifier",
        description: "Legend says this device was crafted by the Great Blocker himself to erase entire sections of Connectopia. It emits a field that temporarily disrupts block structures, causing them to collapse and reform in unpredictable ways! Use it wisely… or face the wrath of a very confused Wario.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 120000,
        icon: '💥',
        stock: 1,
        ...
        stockType: 'special_order',
        effects: [
            "creates a 15-foot radius zone where block structures collapse and reform every 3 rounds.",
            "chance to permanently disable a block structure (10%)",
            "provides +5 bonus to Strength skill checks when manipulating blocks"
        ],
        vendor: 'pioneer_post',
        shippedBy: 'airship',
        levelRequirement: 20
    ...
    'warhammer_chaos_shard': {
        id: 'warhammer_chaos_shard',
        name: "Chaos Shard Warhammer",
        description: "This weapon pulses with raw, untamed chaos! It might randomly explode when you swing it (seriously, be careful), but the damage is absolutely devastating. Wario would totally try to steal this thing.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 8750,
        icon: '💥',
        stock: 12,
        ...
        effects: [
            ...
            "chance to cause a small explosion on hit (30%)",
            "chance to inflict confusion on the target (15%)",
            "bonus to critical hits"
        ],
        vendor: 'chaos_dealer',
        shippedBy: 'dimensional_rift',
        levelRequirement: 10
    ...
    'doughnut_hole_anomaly_wrench': {
        id: 'doughnut_hole_anomaly_wrench',
        name: "The Stabilizer",
        description: "This wrench hums with a faint gravitational pull. It allows the user to briefly manipulate small objects and even counteract minor gravity shifts – perfect for escaping sticky situations or snatching shiny things from the void's grasp.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 7800,
        icon: '🔧',
        stock: 12,
        ...
        stockType: 'limited_daily',
        effects: [
            "allows manipulation of small objects (range: 5m)",
            "provides resistance to gravity effects (50%)",
            "chance to create a localized gravity field"
        ],
        vendor: 'void_vendor',
