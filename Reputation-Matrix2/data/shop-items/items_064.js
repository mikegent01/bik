...
export const ITEMS_064 = {
    ...
    'earth_land_item_frostfang_amulet': {
        id: 'earth_land_item_frostfang_amulet',
        name: "Frostfang Amulet",
        description: "This icy amulet, rumored to be forged from a dragon's frozen breath, grants the wearer resistance to cold and a chilling aura. It’s guaranteed to make your enemies shiver… or maybe just run away! Wario recommends it for frosty dungeon crawls.",
        ...
        effects: [
            "cold resistance +3",
            "chance to inflict shivering (10%)",
            "increased movement speed in snow"
        ],
    ...
    'connectopia_artifact_of_static': {
        id: 'connectopia_artifact_of_static',
        name: "The Null Conduit",
        description: "This shimmering, obsidian-like device is rumored to disrupt electronic systems and cause minor chaos. Wario loves it! It’s perfect for shorting out those pesky automated mining rigs - just don't blame us when things get *really* weird.",
        category: SHOP_CATEGORIES.FORBIDDEN,
        price: 250000,
        icon: '⚡️',
        stock: 1,
        ...
        effects: [
            "chance to disable enemy equipment for 3 turns",
            "causes a small area of electrical damage on hit",
            "disrupts magical effects within a radius"
        ],
        vendor: 'block_smith',
    ...
    'doughnut_hole_void_donut': {
        id: 'doughnut_hole_void_donut',
        name: "Nothingness Nibbler",
        description: "This donut appears to absorb light, and consuming it briefly grants you a glimpse into the void. It's strangely filling...and unsettlingly silent.",
        category: SHOP_CATEGORIES.CONSUMABLES,
        price: 350,
        icon: '🌑',
        stock: 91,
        ...
        stockType: 'in_stock',
        effects: [
            "grant_minor_healing_10hp",
            "brief_vision_of_void_5s",
            "chance_to_avoid_status_effect"
        ],
        vendor: 'doughnut_hole_item_vendor',
