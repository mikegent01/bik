...
export const TOADSLIST_ROSTER = [
    ...
    { num: 2, id: '02_eager', name: "Eager", affiliation: "Archie's Followers", weapon: "Whip", seen: true, portrait: { kind: 'file', file: 'toad_02_eager.png' }, cap: 'Red-Spot', artStatus: 'filed' },
    { num: 3, id: '03_rodger', name: "Rodger", affiliation: "Archie's Followers", weapon: "Sniper", seen: true, portrait: { kind: 'file', file: 'toad_03_rodger.png' }, cap: 'Forest', artStatus: 'filed' },
    { num: 4, id: '04_ryan', name: "Ryan", affiliation: "Archie's Followers", weapon: "Spell Caster", seen: true, portrait: { kind: 'file', file: 'toad_04_ryan.png' }, cap: 'Purple', artStatus: 'filed' },
    ...
    { num: 6, id: '06_bones', name: "Bones", affiliation: "Archie's Followers", weapon: "Fist", seen: true, portrait: { kind: 'file', file: 'toad_06_bones.png' }, cap: 'Red-Spot', artStatus: 'filed' },
    { num: 7, id: '07_perot', name: "Perot", affiliation: "Speaker L Followers", weapon: "Crossbow", seen: true, portrait: { kind: 'file', file: 'toad_07_perot.png' }, cap: 'Red-Spot', artStatus: 'filed' },
    ...
    { num: 10, id: '10_toadburt', name: "Toadburt", affiliation: "Unaffiliated", weapon: "Unarmed", seen: true, portrait: { kind: 'file', file: 'toad_10_toadburt.png' }, cap: 'Cream', artStatus: 'filed' },
    ...
    { num: 13, id: '13_speaker_l', name: "Speaker L", affiliation: "Leaders", weapon: "Megaphone", seen: true, portrait: { kind: 'file', file: 'toad_13_speaker_l.png' }, cap: 'Yellow', artStatus: 'filed' },
    { num: 14, id: '14_elder_mudcap', name: "Elder Mudcap", affiliation: "Leaders", weapon: "Unarmed", seen: false, portrait: { kind: 'file', file: 'toad_14_elder_mudcap.png' }, cap: 'Earth', artStatus: 'filed' },
    ...
    { num: 21, id: '21_kyo', name: "Kyo", affiliation: "Pond Patrol", weapon: "Fishing Spear", seen: true, portrait: { kind: 'file', file: 'toad_21_kyo.png' }, cap: 'Blue', artStatus: 'filed' },
    ...
    { num: 23, id: '23_oiqie', name: "Oiqie", affiliation: "Pond Patrol", weapon: "Ball and Chain", seen: true, portrait: { kind: 'file', file: 'toad_23_oiqie.png' }, cap: 'Purple', artStatus: 'filed' },
    ...
    { num: 26, id: '26_mechal', name: "Mechal", affiliation: "Pond Patrol", weapon: "Huge Improvised Rock sword", seen: true, portrait: { kind: 'file', file: 'toad_26_mechal.png' }, cap: 'Stone', artStatus: 'filed' },
    ...
    { num: 30, id: '30_captain_fernback', name: "Captain Fernback", affiliation: "Pond Patrol", weapon: "Gavel", seen: false, portrait: { kind: 'file', file: 'toad_30_captain_fernback.png' }, cap: 'Navy', artStatus: 'filed' },
    { num: 31, id: '31_dewdrop', name: "Dewdrop", affiliation: "Speaker River Follower", weapon: "Pen", seen: false, portrait: { kind: 'file', file: 'toad_31_dewdrop.png' }, cap: 'Blue', artStatus: 'filed' },
    { num: 32, id: '32_ironspore', name: "Ironspore", affiliation: "Speaker River Follower", weapon: "Spores/Gas", seen: false, portrait: { kind: 'file', file: 'toad_32_ironspore.png' }, cap: 'Forest', artStatus: 'filed' },
    { num: 33, id: '33_metpetal', name: "Metpetal", affiliation: "Speaker River Follower", weapon: "Pointy Flower Blades", seen: false, portrait: { kind: 'file', file: 'toad_33_metpetal.png' }, cap: 'Pink', artStatus: 'filed' },
    { num: 34, id: '34_teacher_t', name: "Teacher T", affiliation: "Teachers", weapon: "Abjuration", seen: false, portrait: { kind: 'file', file: 'toad_34_teacher_t.png' }, cap: 'Earth', artStatus: 'filed' },
    { num: 35, id: '35_bully_t', name: "Bully T", affiliation: "Student Union", weapon: "Evocation", seen: false, portrait: { kind: 'file', file: 'toad_35_bully_t.png' }, cap: 'Crimson', artStatus: 'filed' },
    { num: 36, id: '36_nerd_t', name: "Nerd T", affiliation: "Student Union", weapon: "Divination", seen: false, portrait: { kind: 'file', file: 'toad_36_nerd_t.png' }, cap: 'Sky', artStatus: 'filed' },
    { num: 37, id: '37_geek_t', name: "Geek T", affiliation: "Student Union", weapon: "Conjuration", seen: false, portrait: { kind: 'file', file: 'toad_37_geek_t.png' }, cap: 'Orange', artStatus: 'filed' },
    { num: 38, id: '38_transparen_t', name: "Transparen T", affiliation: "Student Union", weapon: "Illusion", seen: false, portrait: { kind: 'file', file: 'toad_38_transparen_t.png' }, cap: 'Star', artStatus: 'filed' },
    { num: 39, id: '39_necro', name: "Necro", affiliation: "Student Union", weapon: "Necromancy", seen: false, portrait: { kind: 'file', file: 'toad_39_necro.png' }, cap: 'Black', artStatus: 'filed' },
    { num: 40, id: '40_tally', name: "Tally", affiliation: "Student Union", weapon: "Transmutation", seen: false, portrait: { kind: 'file', file: 'toad_40_tally.png' }, cap: 'Yellow', artStatus: 'filed' },
    { num: 41, id: '41_ratie', name: "Ratie", affiliation: "Speaker River Follower", weapon: "Bricks", seen: false, portrait: { kind: 'file', file: 'toad_41_ratie.png' }, cap: 'Brick', artStatus: 'filed' },
    { num: 42, id: '42_kit_t', name: "Kit T", affiliation: "Medics United", weapon: "Breath/Healing breath", seen: false, portrait: { kind: 'file', file: 'toad_42_kit_t.png' }, cap: 'Mint', artStatus: 'filed' },
    { num: 43, id: '43_pondscum', name: "Pondscum", affiliation: "High Command", weapon: "Rifle Ranged Weapon", seen: false, portrait: { kind: 'file', file: 'toad_43_pondscum.png' }, cap: 'Swamp', artStatus: 'filed' },
    ...
    { num: 45, id: '45_inkspot', name: "Inkspot", affiliation: "High Command", weapon: "Ink/ Squid", seen: false, portrait: { kind: 'file', file: 'toad_45_inkspot.png' }, cap: 'Ink', artStatus: 'filed' },
    { num: 46, id: '46_quillback', name: "Quillback", affiliation: "High Command", weapon: "Feathers", seen: false, portrait: { kind: 'file', file: 'toad_46_quillback.png' }, cap: 'Quill', artStatus: 'filed' },
    ...
    { num: 48, id: '48_hammerling', name: "Hammerling", affiliation: "Overseers", weapon: "Hammer", seen: false, portrait: { kind: 'file', file: 'toad_48_hammerling.png' }, cap: 'Copper', artStatus: 'filed' },
    { num: 49, id: '49_spearwort', name: "Spearwort", affiliation: "Overseers", weapon: "Vines/ Pointy vine spears", seen: false, portrait: { kind: 'file', file: 'toad_49_spearwort.png' }, cap: 'Forest', artStatus: 'filed' },
    { num: 50, id: '50_shieldback', name: "Shieldback", affiliation: "Speaker L Followers", weapon: "Riot Shield", seen: false, portrait: { kind: 'file', file: 'toad_50_shieldback.png' }, cap: 'Steel', artStatus: 'filed' },
    { num: 51, id: '51_soothing_moss', name: "Soothing Moss", affiliation: "Deputies", weapon: "Aroma", seen: false, portrait: { kind: 'file', file: 'toad_51_soothing_moss.png' }, cap: 'Moss', artStatus: 'filed' },
    { num: 52, id: '52_gentlepad', name: "Gentlepad", affiliation: "Medics United", weapon: "Long Healing Tounge", seen: false, portrait: { kind: 'file', file: 'toad_52_gentlepad.png' }, cap: 'Rose', artStatus: 'filed' },
    { num: 53, id: '53_shadowleap', name: "Shadowleap", affiliation: "Speaker River Follower", weapon: "Smoke Grenade", seen: false, portrait: { kind: 'file', file: 'toad_53_shadowleap.png' }, cap: 'Charcoal', artStatus: 'filed' },
    { num: 54, id: '54_whispertail', name: "Whispertail", affiliation: "Deputies", weapon: "Spiky Tail", seen: false, portrait: { kind: 'file', file: 'toad_54_whispertail.png' }, cap: 'Taupe', artStatus: 'filed' },
    { num: 55, id: '55_spork', name: "Spork", affiliation: "Spore 5", weapon: "Spore Breath", seen: false, portrait: { kind: 'file', file: 'toad_55_spork.png' }, cap: 'Spore', artStatus: 'filed' },
    { num: 56, id: '56_spik', name: "Spik", affiliation: "Spore 5", weapon: "Spore Touch", seen: false, portrait: { kind: 'file', file: 'toad_56_spik.png' }, cap: 'Spore', artStatus: 'filed' },
    { num: 57, id: '57_speki', name: "Speki", affiliation: "Spore 5", weapon: "Spore sight", seen: false, portrait: { kind: 'file', file: 'toad_57_speki.png' }, cap: 'Spore', artStatus: 'filed' },
    { num: 58, id: '58_spoolo', name: "Spoolo", affiliation: "Spore 5", weapon: "Spore Hearing", seen: false, portrait: { kind: 'file', file: 'toad_58_spoolo.png' }, cap: 'Spore', artStatus: 'filed' },
    { num: 59, id: '59_crai_yellow', name: "Crai Yellow", affiliation: "Lillypads", weapon: "Lightning", seen: false, portrait: { kind: 'file', file: 'toad_59_crai_yellow.png' }, cap: 'Yellow', artStatus: 'filed' },
    { num: 60, id: '60_lualu_green', name: "Lualu Green", affiliation: "Lillypads", weapon: "Grass overgrowth", seen: false, portrait: { kind: 'file', file: 'toad_60_lualu_green.png' }, cap: 'Green', artStatus: 'filed' },
    { num: 61, id: '61_zahue_t_black', name: "Zahue T Black", affiliation: "Lillypads", weapon: "Darkness", seen: false, portrait: { kind: 'file', file: 'toad_61_zahue_t_black.png' }, cap: 'Black', artStatus: 'filed' },
    { num: 62, id: '62_oliver_p', name: "Oliver P", affiliation: "Lillypads", weapon: "Pink gas", seen: false, portrait: { kind: 'file', file: 'toad_62_oliver_p.png' }, cap: 'Pink', artStatus: 'filed' },
    { num: 63, id: '63_poe_white', name: "Poe White", affiliation: "Lillypads", weapon: "Brightness", seen: false, portrait: { kind: 'file', file: 'toad_63_poe_white.png' }, cap: 'White', artStatus: 'filed' },
    { num: 64, id: '64_hustion_gold', name: "Hustion Gold", affiliation: "Lillypads", weapon: "Midas Touch", seen: false, portrait: { kind: 'file', file: 'toad_64_hustion_gold.png' }, cap: 'Gold', artStatus: 'filed' },
    { num: 65, id: '65_sally_silver', name: "Sally Silver", affiliation: "Lillypads", weapon: "Lead weapons", seen: false, portrait: { kind: 'file', file: 'toad_65_sally_silver.png' }, cap: 'Silver', artStatus: 'filed' },
    { num: 66, id: '66_rchie_iser', name: "Rchie Iser", affiliation: "Speaker L Followers", weapon: "Eye beams", seen: false, portrait: { kind: 'file', file: 'toad_66_rchie_iser.png' }, cap: 'Star', artStatus: 'filed' },
    { num: 67, id: '67_kila_t', name: "Kila T", affiliation: "Speaker L Followers", weapon: "knifes", seen: false, portrait: { kind: 'file', file: 'toad_67_kila_t.png' }, cap: 'Crimson', artStatus: 'filed' },
    { num: 68, id: '68_wavey', name: "Wavey", affiliation: "Speaker L Followers", weapon: "Can Control Water", seen: false, portrait: { kind: 'file', file: 'toad_68_wavey.png' }, cap: 'Cyan', artStatus: 'filed' },
    { num: 69, id: '69_unknown', name: "???", affiliation: "Spore 5", weapon: "???", seen: false, portrait: { kind: 'file', file: 'toad_69_unknown.png' }, cap: 'Unknown', artStatus: 'filed' },
    { num: 70, id: '70_barie', name: "Barie", affiliation: "Speaker River Follower", weapon: "Bite", seen: false, portrait: { kind: 'file', file: 'toad_70_barie.png' }, cap: 'Ivory', artStatus: 'filed' },
    { num: 71, id: '71_caerk', name: "Caerk", affiliation: "Speaker L Followers", weapon: "Baking tools", seen: false, portrait: { kind: 'file', file: 'toad_71_caerk.png' }, cap: 'White', artStatus: 'filed' },
    { num: 72, id: '72_nat', name: "Nat", affiliation: "Speaker L Followers", weapon: "Bug Spray", seen: false, portrait: { kind: 'file', file: 'toad_72_nat.png' }, cap: 'Olive', artStatus: 'filed' },
    { num: 73, id: '73_toad_ie_foxx', name: "Toad ie Foxx", affiliation: "Speaker River Follower", weapon: "Fox Tail", seen: false, portrait: { kind: 'file', file: 'toad_73_toad_ie_foxx.png' }, cap: 'Forest', artStatus: 'filed' },
    { num: 74, id: '74_anne_ari_t', name: "Anne Ari T", affiliation: "Speaker L Followers", weapon: "Bug  Jar", seen: false, portrait: { kind: 'file', file: 'toad_74_anne_ari_t.png' }, cap: 'Yellow', artStatus: 'filed' },
    { num: 75, id: '75_4331_t', name: "4331 T", affiliation: "Speaker River Follower", weapon: "Calculator", seen: false, portrait: { kind: 'file', file: 'toad_75_4331_t.png' }, cap: 'Star', artStatus: 'filed' },
];
...
export const VOTE_RECORDS = [
    ...
    },
    {
        ...
        summary: 'Position 1 is elected by tiers 6 and 7. After the ouster, Archie’s Followers and Speaker River followers stand for Rivers; Speaker L Followers stand for the rival chair. Unions were not recorded on the workbook.',
        source: 'Toadslist.xlsx — Leadership Positions',
        ballots: [
            { side: 'Rivers', blocs: ["Archie's Followers", 'Speaker River Follower'] },
            { side: 'Speaker L', blocs: ['Speaker L Followers'] },
            { side: 'Unrecorded', blocs: ['Teachers', 'Student Union', 'Medics United', 'Lillypads'] }
        ]
    },
    {
        id: 'ARMY-POND-PATROL',
        ...
        tally: { yes: null, no: null, abstain: null, turnout: null },
        result: 'Army formed',
        summary: 'Cohort List sheet: Pond Patrol — “Formed through vote.” Armies are created by a vote of tiers 6 and 7. The Spore 5 was not chosen; it is rogue.',
        source: 'Toadslist.xlsx — Cohort List',
        ballots: [
            { side: 'Form the Patrol', blocs: ["Archie's Followers", 'Speaker River Follower', 'Speaker L Followers'] },
            { side: 'Not recorded', blocs: ['Teachers', 'Student Union', 'Medics United', 'Lillypads'] }
        ]
    },
    {
        id: 'FIRST-COHORT',
        title: 'First named cohort (the 74)',
        kind: 'Full cohort',
        tally: { yes: 78, no: 59, abstain: null, turnout: 137 },
        result: 'Carried — the Liberated Toads exist',
        summary: 'The same founding division as the 78–59 vote: the people who walked out of the barrels became a polity. Later intake named seventy-four of them.',
        source: 'data/factions.json → liberated_toads (same tally as FOUNDING)'
    }
];
