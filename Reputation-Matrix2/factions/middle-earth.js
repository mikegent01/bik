...
export const MIDDLE_EARTH_FACTIONS = {
    kingdom_of_gondor: {
        ...
        logo: 'assets/images/factions/kingdom_of_gondor.png',
        relations: {
    ...
    kingdom_of_rohan: {
        ...
        logo: 'assets/images/factions/kingdom_of_rohan.png',
        relations: {
    ...
    lothlorien: {
        ...
        logo: 'assets/images/factions/lothlorien.png',
        relations: {
    ...
    elves_of_lindon: {
        ...
        logo: 'assets/images/factions/elves_of_lindon.png',
        relations: {
    ...
    kingdoms_of_the_dwarves: {
        ...
        logo: 'assets/images/factions/kingdoms_of_the_dwarves.png',
        relations: {
    ...
    isengard: {
        ...
        logo: 'assets/images/factions/isengard.png',
        relations: {
            allies: ['mordor'],
    ...
    mordor: {
        ...
        logo: 'assets/images/factions/mordor.png',
        relations: {
            allies: ['isengard'],
