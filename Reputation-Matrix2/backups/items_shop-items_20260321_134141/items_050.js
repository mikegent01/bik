// Shop items chunk 50 of 51
// Items 4901 to 5000 (100 items)
...
export const ITEMS_050 = {
  ...
  'weights_treadmills_and_protein_shakes_1': {
        id: 'weights_treadmills_and_protein_shakes_1',
  ...
  'whiskey_that_s_strong_garlic_1': {
    id: 'whiskey_that_s_strong_garlic_1',
  ...
  'worn_by_those_who_dare_1': {
        id: 'worn_by_those_who_dare_1',
  ...
  'worn_by_those_who_walk_1': {
        id: 'worn_by_those_who_walk_1',
        name: "Void Touched Amulet",
  ...
  'woven_from_shadows_of_the': {
        id: 'woven_from_shadows_of_the',
        name: "Feywild Talisman",
        description: "Woven from shadows of the Feywild, this talisman grants temporary access to the hidden realm. Perfect for exploring the split Raventree Manor or escaping to the fey.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 7000,
        icon: '🌿',
        stock: 1,
        rarity: 'legendary',
        effects: [
            "Opens a portal to Feywild for 30 seconds",
        "+20% damage to summoned fey creatures",
        "+10% chance to gain a fey ally during combat"
        ],
        vendor: 'dk_isles',
  ...
  'woven_from_the_laughter_of_1': {
        id: 'woven_from_the_laughter_of_1',
  ...
  'your_prophecies_are_edible_1': {
    id: 'your_prophecies_are_edible_1',
