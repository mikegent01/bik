// Shop items chunk 25 of 51
// Items 2401 to 2500 (100 items)
...
export const ITEMS_025 = {
  ...
  'isle_delfino_tropical_scent_tincture': {
        ...
        description: "A fragrant elixir infused with sun-kissed blooms and sea breeze. Enhances movement speed and provides temporary resistance to environmental hazards. Ideal for navigating stormy beaches or dense jungle paths.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 500,
        icon: '🌴',
        stock: 7,
        ...
        "Grants 20% resistance to environmental damage",
        "Restores 10% HP upon use"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Pipe Express',
        levelRequirement: 3
  ...
  'isle_delfino_tropical_shield': {
        ...
        description: "A shimmering, leaf-patterned shield that deflects physical attacks with a tropical breeze. Also grants a refreshing cool-down effect for nearby allies.",
        ...
        rarity: 'rare',
        effects: [
            "Deflects 15% of incoming physical damage",
        "Grants 5% defense boost to allies within 5 meters",
        "Reduces cooldown of all party members by 2 seconds after use"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Pipe Express',
        levelRequirement: 8
  ...
  'isle_delfino_tropical_shine_bloom': {
        ...
        description: "A radiant flower that glows with the energy of the sun and sea. When worn, it grants temporary speed boosts and buffs your sprite’s charm to nearby allies. Perfect for beachside battles or relaxing after a tough fight.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        "Increases charm damage by 15% for allies within 3 tiles",
        "Grants a 5% chance to dodge attacks when near water"
        ],
        vendor: 'isle_delfino',
  ...
  'isle_delfino_tropical_shine_bottle': {
        ...
        description: "Sips of radiant sunshine captured in glass. Boosts morale and restores vitality during long beach patrols. Shines brighter in the sun, making enemies blink in the glare.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 1200,
        icon: '🌞',
        stock: 7,
        ...
        "Grants +20% chance to hit in sunny weather"
        ],
        vendor: 'isle_delfino',
  ...
  'isle_delfino_tropical_shine_spritewings': {
        ...
        description: "Flutter through the sun-drenched skies with grace and speed. These wings amplify your agility and grant a brief burst of radiant light during combat. Perfect for acrobatic dodges and aerial assaults.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "+30% mobility speed while airborne",
        "+20% chance to dodge attacks while airborne",
        "Deals 10% extra damage to enemies in sunlight zones"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_silk_satchel': {
        ...
        description: "Lightweight and dappled with shimmering vines, this satchel stores items with a gentle glow. Perfect for quick trips or party coordination.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🌴',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Can carry up to 3x normal item capacity",
        "Grants +5% chance to find hidden items in zones",
        "Grants a +10% chance to recover a lost item when using the item"
        ],
        vendor: 'isle_delfino',
  ...
  'isle_delfino_tropical_spirit_torch': {
        ...
        description: "Emits a radiant glow that soothes nearby allies and boosts morale. When held, it subtly summons shimmering Shine Sprites to assist in combat. Perfect for beachside battles or festive gatherings.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 1200,
        icon: '🔮',
        stock: 5,
        rarity: 'rare',
        effects: [
            "Boosts morale by 30% for 10 seconds",
        "Summons 3 Shine Sprites for 5 seconds",
        "Reduces enemy attack speed by 15% for 3 seconds"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Void Drifter Relay',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_sprout': {
        ...
        description: "A glowing leaf-shaped amulet that pulses with the energy of the island’s sunlit flora. Wearing it grants temporary boosts to all natural-based abilities and enhances healing from sunlight.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Boosts natural ability recovery by 20%",
        "Increases healing from sunlight by 30%",
        "Grants minor resistance to poison from jungle creatures"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_sprout_pearl': {
        ...
        description: "A shimmering pearl grown from a sunlit mangrove root, this item grants temporary boosts to agility and charm. Perfect for navigating the island’s hidden waterways or charming shy creatures.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 1200,
        icon: '🌴',
        stock: 5,
        ...
        effects: [
            "+20% movement speed for 10 seconds",
        "+15% chance to bypass enemy stealth",
        "+10% chance to trigger a friendly encounter with a Shine Sprite"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_sunburst_gear': {
        ...
        description: "A shimmering alloy suit that glows with radiant sunbeams, granting enhanced speed and light-based attacks. Perfect for navigating the bright, breezy paths of Isle Delfino.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        "+10% chance to deal critical damage on hit"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_tide': {
        ...
        name: "Tropical Tide",
        description: "A shimmering, water-infused charm that pulses with the rhythm of the ocean. Enhances swimming speed and reduces underwater damage.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 1800,
        icon: '🌊',
        stock: 4,
        rarity: 'rare',
        effects: [
            "Boosts swim speed by 30% for 15 seconds",
        "Reduces underwater damage taken by 40%",
        "Increases chance to recover from drowning by 25%"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_tide_cape': {
        ...
        description: "Drapes in shimmering, wave-patterned fabric that hums with oceanic energy. Grants the wearer temporary resistance to drowning and boosts swim speed by 20%. Perfect for exploring the island’s hidden lagoons.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        "+20% swim speed",
        "Glows with bioluminescent patterns when near water"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_tide_gear': {
        ...
        description: "This shimmering coral-patterned armor grants the wearer radiant resistance to sunburn and drowning. Perfect for beachside combat or relaxing in the lagoon.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "+10% chance to dodge water-based attacks",
        "Grants +20% HP regeneration while submerged",
        "Increases movement speed by 15% on sandy terrain"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Rakasha Spirit Walk',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_tide_rod': {
        ...
        description: "A magical fishing rod infused with Shine Sprite magic and oceanic resonance. Can summon rare sea creatures and yield valuable resources from deep reefs.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "30% chance to catch rare sea creatures",
        "Grants +15% resource yield from underwater zones",
        "Increases fishing speed by 20%"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Rakasha Spirit Walk',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_tide_sword': {
        ...
        description: "A shimmering blade forged from the ocean’s whisper, it glows with neon coral hues when struck. Perfect for slicing through reality’s frayed edges during the Fractured Atrium event.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Deals extra damage to Reality Fragments",
        "Grants 10% chance to trigger a shimmering dodge animation",
        "Increases movement speed by 15% underwater or in dream-surf zones"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Koopa Postal',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_tide_torch': {
        ...
        description: "Illuminates the night with a warm, glowing light that mimics the sun’s embrace. Perfect for beachside patrols or feasts under the stars. Glows brighter when surrounded by water.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "+10% chance to detect hidden paths in water",
        "Grants temporary swim speed boost when lit",
        "Emits soothing aura that heals 10% HP per second while active"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Koopa Postal',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_tide_trooper': {
        ...
        description: "A shimmering toad-scaled armor set that glows with the rhythm of ocean waves. Grants temporary speed boosts during beachside battles and heals minor wounds from sun exposure.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "+20% movement speed while in water or on beach terrain",
        "Regenerates 10% HP per second while submerged or in sunlight",
        "Resists drowning damage for 2 seconds after taking damage"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Koopa Postal',
        levelRequirement: 5
  ...
  'isle_delfino_tropical_tide_umbrella': {
        ...
        description: "A shimmering parasol that shields you from sun and rain alike while casting a gentle glow that attracts Shine Sprites. Perfect for beachside battles or relaxing under the canopy of the Feywild.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "+10% chance to attract Shine Sprites during combat",
        "Reduces damage taken from water-based attacks",
        "Grants a 50% chance to heal 15% of max HP when used in sunlight"
        ],
        vendor: 'isle_delfino',
  ...
  'isle_delfino_tropical_tonic': {
        ...
        description: "A glowing, fizzy drink that restores vitality and grants temporary speed boosts. Perfect for sprinting through palm tree jungles or dodging falling parrots.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 1200,
        icon: '🍹',
        stock: 5,
        ...
        effects: [
            "Restores 50% max HP",
        "+15% movement speed for 30 seconds",
        "Causes minor glittering effect on enemies (visual only)"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Void Drifter Relay',
        levelRequirement: 3
  ...
  'isle_delfino_tropical_wardrobe': {
        ...
        description: "A lightweight, enchanted garment that shifts between 3 tropical styles—beach, jungle, or sky—each granting a different elemental effect. Perfect for adventurers who love to change their look and their power.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3500,
        icon: '🌴',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Switches between 3 elemental forms (fire wind, water splash, earth tremor)",
        "Each form lasts 3 turns and grants 1 elemental bonus",
        "Increases speed by 15% while in active form"
        ],
        vendor: 'isle_delfino',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
  ...
  'isle_delfino_walucore_bottle': {
        ...
        description: "A mysterious vial containing the essence of Waluigi’s fallen spirit—now bound in liquid light. When consumed, it restores HP and boosts courage. Only obtainable after the event.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 5000,
        icon: '💀',
        stock: 1,
        ...
        effects: [
            "Restores 30 HP",
        "Grants +20% chance to dodge next attack",
        "Increases resistance to fear by 30% for 3 turns",
