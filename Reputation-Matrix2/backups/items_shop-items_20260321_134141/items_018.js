// Shop items chunk 18 of 51
// Items 1701 to 1800 (100 items)
...
export const ITEMS_018 = {
  'fractured_atrium_shadow_soul': {
        ...
        description: "Worn by the faithful of the Deep Mirror, this amulet binds the soul of the wearer to the realm of the drowned. It grants the ability to summon spectral guardians during battle, and slows time for 2 seconds on touch.",
        ...
        rarity: 'rare',
        effects: [
            "Summons 1 spectral guardian for 15 seconds",
        "Slows time by 20% for 2 seconds on touch",
  ...
  'fractured_atrium_shadow_wraith_blade': {
        ...
        description: "A blade forged from the shattered essence of a fallen necromancer’s soul, it whispers to the dead and cleaves through incorporeal foes. Its edge glows with the faint pulse of the Shadowfell.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        "Inflicts Corruption on enemies, reducing their HP by 20% per turn",
        "Grants 10% chance to revive ally after death (if wielder is in combat)"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Shy Guy Smugglers',
        levelRequirement: 5
  ...
  'fractured_atrium_shadow_writ': {
        ...
        description: "A necromantic scroll etched with the sigils of the fallen, granting temporary control over spectral minions. When wielded, it whispers the deads commands into the void.",
        ...
        rarity: 'rare',
        effects: [
            "Summons 3 spectral undead minions for 3 rounds",
        "Inflicts 20% damage reduction to attacker",
        "Grants 50% chance to negate enemy melee attacks"
        ],
        vendor: 'fractured_atrium',
  ...
  'fractured_atrium_shadowshroud_cloak': {
        ...
        description: "A necromantic garment that absorbs ambient darkness and reflects it as a shield. Wearing it allows you to phase between life and death, granting temporary invisibility to undead foes.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3500,
        icon: '🔮',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Absorbs 50% of incoming damage from undead",
        "15% chance to appear invisible to enemies for 5 seconds",
        "Grants +10% to all necromancy skill damage"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Rakasha Spirit Walk',
        levelRequirement: 5
  ...
  'fractured_atrium_shattered_echo': {
        ...
        description: "A fractured shard of the Deep Mirror that whispers secrets of forgotten realms. When wielded, it reveals hidden truths within the Fractured Atrium’s unstable corridors. Splits your perception into three visions, each showing a different path forward.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Reveals hidden paths in the Fractured Atrium",
        "Splits perception into three visions (each with a different outcome)",
        "Increases chance of finding rare artifacts in mirrored zones"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Rakasha Spirit Walk',
        levelRequirement: 5
  ...
  'fractured_atrium_shattered_mirror_core': {
        ...
        description: "A fragment of the Deep Mirror’s shattered soul. When imbued with necromantic power, it becomes a conduit for summoning entities from the abyssal veil.",
        ...
        rarity: 'rare',
        effects: [
            "Required to craft “Abyssal Summoner’s Tome”",
        "Grants +50% summoning power when infused with Corvinarus blood",
        "Increases necromancy cooldown reduction by 15%"
        ],
        vendor: 'fractured_atrium',
  ...
  'fractured_atrium_shattered_reflection': {
        ...
        description: "A fractured mirror shard that whispers the memories of those who have perished in the Atrium. When wielded, it reflects not the enemy’s form but their deepest fear—making necromantic foes recoil from their own ghosts.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Reflects enemy’s innermost fear for 3 seconds",
        "Inflicts 10% damage reduction to necromantic minions",
        "Grants 5% chance to reveal hidden enemy spawn points"
        ],
        vendor: 'fractured_atrium',
  ...
  'fractured_atrium_shroud_of_the_hollow_heart': {
        ...
        description: "Woven from the last breath of a fallen necromancer’s soul, this shroud dampens magical backlash and grants temporary resistance to curses. When worn, it whispers the name of the deceased in the wearer’s mind, offering a fleeting glimpse of their final thoughts.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Reduces curse resistance by 30%",
        "Grants 10 seconds of silence immunity while wearing",
        "Whisper of the Dead: Once per battle, reveals the location of a nearby undead enemy"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Void Drifter Relay',
        levelRequirement: 5
  ...
  'fractured_atrium_soul_amber': {
        ...
        description: "A fractured relic of the Deep Mirror’s core, this shard pulses with necromantic resonance. When worn, it grants the user glimpses into the dead’s memories and allows temporary summoning of spectral servants.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Grants +15% damage to necromantic spells",
        "Temporary summoning of 1 spectral minion for 10 seconds per use",
        "Reduces necromantic spell cooldowns by 20%"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Shy Guy Smugglers',
        levelRequirement: 5
  ...
  'fractured_atrium_soul_crystal_fragment': {
        ...
        description: "A shard of a corrupted soul that once bound a necromancer to the void. When imbued with magic, it amplifies necromantic spells and drains life from the caster’s surroundings. Wielders report visions of the dead during use.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 2000,
        icon: '🔮',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Increases necromantic spell damage by 25%",
        "Consumes 10% of caster’s current HP to fuel spell",
        "Vision of the Dead: Briefly reveals all nearby undead for 3 seconds"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Void Drifter Relay',
        levelRequirement: 5
  ...
  'fractured_atrium_soul_echo': {
        ...
        description: "A fractured mirror shard that amplifies necromantic chants by echoing the user’s voice into spectral echoes. Perfect for summoning the dead or amplifying ritual power. Emits a low hum that disorients foes within 5 meters.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Echo Amplifier: +30% damage to necromantic spells",
        "Phantom Whisper: Disorients targets within 5m for 3 seconds",
        "Soul Resonance: Grants 10% chance to summon a spectral ally for 1 round"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Rakasha Spirit Walk',
        levelRequirement: 5
  ...
  'fractured_atrium_soul_mirrors': {
        ...
        description: "A set of 3 crystal shards that reflect the soul of the wielder. Each shard grants a different necromantic power, but the cost is your memories—lost, forgotten, or erased.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Each shard grants one unique necromantic ability (e.g. Summon Corpse, Summon Shadow, Summon Soulbound)",
        "Wielder loses 1 memory point per ability used",
        "When all shards are active, grants 50% chance to dodge all necrotic damage"
        ],
        vendor: 'fractured_atrium',
  ...
  'fractured_atrium_soul_refractor': {
        ...
        name: "Soul Refractor",
        description: "A device that bends the flow of necromantic energy, allowing spells to be cast without visible cost. Perfect for covert operations in the Atrium’s mirrored depths.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Spells cast consume no MP",
        "Grants 10% bonus to necromancy skill for 3 turns",
        "Triggers a shadow echo when enemy is within 3 tiles"
        ],
        vendor: 'fractured_atrium',
  ...
  'fractured_atrium_soul_shard': {
        ...
        description: "A fractured fragment of the Deep Mirror’s core, humming with necromantic resonance. When wielded, it amplifies the caster’s ability to command undead and reflects their will into spectral forms.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        "Reflects caster’s will into 3 spectral minions",
        "10% chance to summon a spectral echo during combat"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Void Drifter Relay',
        levelRequirement: 5
  ...
  'fractured_atrium_soul_siphon': {
        ...
        name: "Soul Siphon",
        description: "A dark artifact that drains life force from enemies to fuel the caster. Each soul drained enhances the user’s necromantic power for the next 30 seconds.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 2500,
        icon: '🔮',
        stock: 4,
        rarity: 'rare',
        effects: [
            "Siphons 10% of enemy HP to restore 15% of caster HP",
        "Enhances next 30 seconds of necromancy spell damage by 30%",
        "Increases spell duration by 20% for all necromantic abilities"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Shy Guy Smugglers',
        levelRequirement: 5
  ...
  'fractured_atrium_soul_tomb_key': {
        ...
        description: "A key carved from obsidian and bone, granting access to the inner sanctum of the Deep Mirror. It unlocks a hidden ritual chamber, but at the cost of the wielder’s soul.",
        category: SHOP_CATEGORIES.MATERIAL,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Opens “The Forgotten Chamber” for 10 minutes",
        "Consuming this key binds the wielder to the chamber’s dark echo",
        "Grants “Soul Anchor” passive: restores 5% HP per second while inside the chamber"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'fractured_atrium_spectral_blood_siphon': {
        ...
        description: "Siphons life essence from undead foes, converting it into temporary necrotic power. Perfect for necromancers seeking to fuel their dark rituals with raw vitality. Emits a chilling hum when active.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Siphons 10% HP from undead enemies into caster’s necrotic pool",
        "Grants +50% damage to necromantic spells while active",
        "Reduces caster’s fatigue by 10% per second of usage"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'fractured_atrium_spectral_key': {
        ...
        description: "A broken artifact that opens sealed necromantic chambers. When activated, it summons a spectral guardian to protect the user, but the guardian is bound to the user’s soul. Do not use in combat without a soul anchor.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Opens 1 sealed necromantic chamber",
        "Grants 20% chance to summon spectral guardian",
        "Requires soul anchor to activate guardian"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'fractured_atrium_spectral_scarf': {
        ...
        description: "Woven from the remnants of a fallen mirror’s soul, this scarf whispers forgotten memories to the wielder. When worn, it grants temporary necrotic vision and amplifies shadow-based spells.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Grants +30% damage to shadow spells",
        "Reveals hidden enemy weaknesses for 10 seconds",
        "Negates one curse effect per combat round"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'fractured_atrium_spectral_soul_tome': {
        ...
        description: "A forbidden grimoire bound in the skin of a resurrected warlord. It contains the secrets of the Deep Mirror’s forgotten rituals and allows the user to manipulate the echoes of death.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Consuming the tome grants +100% necromantic power for 10 seconds",
        "Activates “Mirror Echo” ability: All undead nearby gain +50% damage resistance",
        "Can be used to cast “Final Whisper” — instantly resurrects one ally at 30% HP"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Void Drifter Relay',
        levelRequirement: 5
  ...
  'fractured_atrium_void_echo': {
        ...
        description: "A whispering orb that mirrors the caster’s soul. When activated, it echoes the caster’s memories and allows them to command the dead with a single voice.",
        ...
        rarity: 'rare',
        effects: [
            "Echoes caster’s memories for 3 turns",
        "Grants +20% necromancy duration",
        "5% chance to summon a spectral echo of the caster"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Void Drifter Relay',
        levelRequirement: 5
  ...
  'fractured_atrium_wraith_chime': {
        ...
        description: "This hollow chime, shaped like a skull, hums with the echoes of the dead. When played, it summons a spectral warden for 1 round, capable of turning undead into temporary allies.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 1800,
        icon: '🔮',
        stock: 4,
        rarity: 'rare',
        effects: [
            "Summons a spectral warden (1 turn)",
        "+50% damage to undead",
        "Warden gains +20% defense for 3 turns"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Rakasha Spirit Walk',
        levelRequirement: 5
  ...
  'fractured_atrium_wraith_forged_chestplate': {
        ...
        description: "A chestplate etched with mirror runes that reflect and absorb enemy spells. Grants the wearer temporary invisibility and amplifies necromantic power.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2800,
        icon: '🔮',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Reflects 30% of incoming magical damage back to the attacker",
        "Grants 10% chance to become invisible for 5 seconds",
        "Increases necromantic spell cast speed by 20%"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Lakitu Drones',
        levelRequirement: 5
  ...
  'fractured_atrium_wraith_scarf': {
        ...
        description: "A shrouded scarf woven from the remnants of a fallen Corvinarus lord. Wears it to absorb necrotic damage and channel it into devastating spectral strikes. A noble relic of the Deep Mirror’s forgotten war.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Absorbs 1d4 necrotic damage per round",
        "Grants +10% to necromantic spells when channeling damage",
        "Causes 1d4 necrotic damage to enemies upon casting"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Shy Guy Smugglers',
        levelRequirement: 5
  ...
  'fractured_atrium_wraith_tether': {
        ...
        name: "Wraith Tether",
        description: "A thread of spectral energy woven from the bones of fallen Corvinarus. Ties to the nearest undead entity, forcing them to obey your commands—until the thread breaks under pressure.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Commands 1 nearby undead for 5 seconds (can be disrupted)",
        "Inflicts 15% damage reduction to necromantic allies",
        "Grants +5% damage bonus to necromantic abilities"
        ],
        vendor: 'fractured_atrium',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'fryer_with_furious_bubbles_for_1': {
    id: 'fryer_with_furious_bubbles_for_1',
  ...
  'get_one_spell_slot_back_1': {
    id: 'get_one_spell_slot_back_1',
