...
export const ITEMS_071 = {
    ...
    'faction_chaos_scrolls': {
        id: 'faction_chaos_scrolls',
        name: "Scroll of Unraveling Fate",
        description: "These chaotic scrolls pulse with raw, unpredictable energy. They offer a glimpse into the shifting currents of fate, but be warned – attempting to control them could tear you apart! Wario recommends using these for…experimentation.",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 7500,
        icon: '🌀',
        stock: 3,
        ...
        stockType: 'limited_daily',
        effects: [
            "random_effect_chance",
            "chance_to_stun",
            "temporary_stat_boost"
        ],
        vendor: 'chaos_dealer',
        shippedBy: 'flying_skull',
        levelRequirement: 12
    },
    ...
    'animatopia_beetle_charm_of_harmony': {
        id: 'animatopia_beetle_charm_of_harmony',
        name: "Buzzing Harmony Charm",
        description: "This tiny charm, crafted from a beetle's iridescent shell and strung on woven vines, radiates an aura of tranquility. Wearing it reduces the stress caused by combat, granting you increased focus and resilience – just don’t try to eat it!",
        category: SHOP_CATEGORIES.CONSUMABLES,
        price: 350,
        icon: '🐞',
        stock: 98,
    ...
    'grand_country_crumb_of_eternity': {
        id: 'grand_country_crumb_of_eternity',
        name: "Crumb of Eternity",
        description: "A shimmering fragment harvested from a collapsing spire, said to contain echoes of forgotten moments. This crumb bestows a temporary burst of vitality – perfect for escaping a sticky situation or just feeling extra Wario-ish!",
        category: SHOP_CATEGORIES.CONSUMABLES,
        price: 7500,
        icon: '✨',
        stock: 42,
        ...
        effects: [
            "restores 50 HP",
            "grants +1 movement speed for 3 turns",
            "chance to trigger a minor luck effect (roll double on next skill check)"
        ],
        vendor: 'vertical_vendor',
        shippedBy: 'gravity_tube',
        levelRequirement: 6
    },
