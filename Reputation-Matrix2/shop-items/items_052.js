...
export const ITEMS_052 = {
    ...
    'faerun_item_rusty_dragonscale': {
        id: 'faerun_item_rusty_dragonscale',
        name: "Rusty Dragonscale Shield",
        description: "This shield looks like it’s been through a few too many goblin skirmishes! It still offers decent protection, and Wario's pretty sure he saw a dragon wearing something similar once… probably just a really grumpy lizard.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3500,
        icon: '🛡️',
        stock: 67,
        ...
        effects: [
            "armor_class +1",
            "chance to deflect ranged attacks (10%)",
