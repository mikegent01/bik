// Shop items file 62
// Generated: 2026-03-21 16:44:22
// Items: 100

import { SHOP_CATEGORIES } from './categories.js';

export const ITEMS_062 = {
    'doughnut_hole_center_ritual': {
        id: 'doughnut_hole_center_ritual',
        name: "Echo of the Center",
        description: "A shimmering, gelatinous sphere that whispers forgotten prophecies. This premium service allows you to briefly glimpse potential futures – though beware, the void doesn't appreciate being consulted!",
        ...
        effects: [
            "provides a cryptic vision of the future (random effect)",
            "chance to gain knowledge about upcoming events",
            "temporary boost to wisdom stat"
        ],
        vendor: 'center_seller',
        shippedBy: 'chronal_wave',
        levelRequirement: 10
    },
    ...
    'almost_edge_resonance_shard': {
        id: 'almost_edge_resonance_shard',
        name: "Resonance Shard",
        description: "This jagged shard pulses with a faint, unsettling vibration - a trapped echo of the boundary between worlds. Holding this shard allows you to briefly perceive distortions in space and time, potentially revealing hidden passages or traps, but beware its effects...",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 1800,
        icon: '🔮',
        stock: 67,
        ...
        stockType: 'in_stock',
        effects: [
            "increases perception by 5 for 3 turns",
            "chance to reveal hidden passages (10%)",
            "absorbs 25% of damage from temporal anomalies"
        ],
    ...
    'warhammer_chaosshard': {
        id: 'warhammer_chaosshard',
        name: "Shard of Unmaking",
        description: "A pulsing fragment of pure chaos, this obsidian shard seems to warp reality around it. Holding it grants a momentary boost to attack speed, but be warned – prolonged use could unravel your very being! Wario would totally try to sell you this…probably.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 8750,
        icon: '💥',
        stock: 12,
        ...
        stockType: 'limited_daily',
        effects: [
            "attack speed +30% for 5 seconds",
            "chance to cause confusion",
            "small chance of self-damage"
        ],
        vendor: 'chaos_dealer',
    ...
    'almost_edge_item_whispering_shard': {
        id: 'almost_edge_item_whispering_shard',
        name: "Whispering Shard of the Void",
        description: "This jagged fragment pulses with an unsettling cold, murmuring secrets best left unheard. Holding it for too long may cause vivid hallucinations or a desperate urge to… well, step off the edge.",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 18000,
        icon: '🌌',
        stock: 35,
        ...
        stockType: 'limited_daily',
        effects: [
            "chance to inflict madness (5%)",
            "grants +1 to perception checks",
            "provides minor void resistance"
        ],
        vendor: 'void_merchant',
    ...
    'earth_land_goblin_gut_potion': {
        id: 'earth_land_goblin_gut_potion',
        name: "Goblin Gut Potion",
        description: "This vile concoction smells suspiciously like fermented swamp cabbage and goblin sweat, but hey, it's got a kick! Drink this to temporarily increase your strength – just don’t blame us if you start belching bubbles.",
        category: SHOP_CATEGORIES.CONSUMABLES,
        price: 250,
        icon: '🤢',
        stock: 78,
        ...
        stockType: 'in_stock',
        effects: [
            "strength +3 for 6 turns",
            "chance to cause uncontrollable laughter (10%)"
        ],
        vendor: 'guild_quartermaster',
    ...
    'almost_edge_item_void_lantern': {
        id: 'almost_edge_item_void_lantern',
        name: "Lantern of the Unseen Depths",
        description: "This lantern doesn't emit light, but rather a swirling vortex of nothingness. It’s perfect for exploring the darkest corners… or just scaring your friends!",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 8500,
        icon: '🔦',
        stock: 15,
