// Shop items chunk 30 of 51
// Items 2901 to 3000 (100 items)
...
export const ITEMS_030 = {
  'midlands_steel_heart': {
        ...
        description: "A forged heart of molten steel that pulses with industrial might. Wields the power of the forge’s soul, granting immense durability and a minor boost to melee strikes.",
        ...
        rarity: 'rare',
        effects: [
            "+50% armor against blunt and crushing damage",
  ...
  'midlands_steel_heart_heart': {
        ...
        description: "A mechanical relic of the Iron Legion’s innermost command, this item restores vitality through industrial might. When activated, it regenerates health and grants temporary invincibility.",
        ...
        rarity: 'rare',
        effects: [
            "+50% health regeneration per 5 seconds",
        "Grants +20% armor for 10 seconds after use",
        "+10% chance to trigger “Iron Will” – ignores 10% of enemy damage"
        ],
        vendor: 'midlands',
  ...
  'midlands_steel_hood': {
        ...
        description: "A helmet molded from the molten heart of a forgotten forge. It shields the wearer from physical blows and whispers iron truths when struck. Glows faintly in the dark, revealing hidden gear paths.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2000,
        icon: '📦',
        stock: 4,
        ...
        effects: [
            "+25% armor",
        "+15% dodge chance on enemy attacks",
        "+5% chance to reveal hidden path on map"
        ],
        vendor: 'midlands',
  ...
  'midlands_steel_maw': {
        ...
        description: "A massive, rusted gear-laced maw that devours enemy armor and converts it into raw steel. Perfect for the blacksmiths of the Regal Empire who seek to forge their own destiny.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "+15% damage to heavy armor targets",
        "+20% chance to break enemy armor on hit",
        "Grants +50% bonus to forge efficiency while equipped"
        ],
        vendor: 'midlands',
        shippedBy: 'Shy Guy Smugglers',
        levelRequirement: 5
  ...
  'midlands_steel_maw_gear': {
        ...
        name: "Steel Maw Gear",
        description: "A massive gear forged from the teeth of a fallen war machine. Worn on the arm, it grants the wearer the ability to manipulate machinery and trigger explosive mechanisms.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3500,
        icon: '📦',
        stock: 1,
        rarity: 'rare',
        effects: [
            "Can trigger explosive mechanisms within 10m",
        "+15% damage to mechanical targets",
        "Grants a 5-second cooldown on “Gear Smash” ability"
        ],
        vendor: 'midlands',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 6
  ...
  'midlands_steel_soul_amulet': {
        ...
        description: "A forged amulet of iron and obsidian, humming with the memory of Legion steel. Wears the soul of a fallen anvil-mender, granting strength to the oppressed and protection to the oppressed.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "+1000 max HP when near iron ore veins",
        "+500 damage to enemy armor",
        "Immunity to poison from Legion mines"
        ],
        vendor: 'midlands',
  ...
  'midlands_steel_soul_belt': {
        ...
        description: "Woven from the marrow of a fallen war-machine, this belt binds the wearer to the forge’s heartbeat. Grants temporary invulnerability during strikes, but causes a 30-second cooldown after every use.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
  ...
  'midlands_steel_soul_charger': {
        ...
        description: "A rusted iron core fused with toad-prisoners stolen essence. Powers armor with a pulse of raw industrial fury. Slightly increases damage output and regenerates stamina after 10 seconds.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        effects: [
            "+20% melee damage",
        "Regenerates 10% stamina per 10 seconds",
        "Grants 5% chance to cause Industrial Overload (temporary 30% damage boost and 100% armor penetration)"
        ],
        vendor: 'midlands',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'midlands_steel_soul_potion': {
        ...
        description: "A potent elixir infused with the essence of an ancient forge spirit. Sips this to temporarily empower your steel gear, granting you the ability to withstand heavy blows and restore your armor’s integrity.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Restores 10% armor integrity after use",
        "Grants +10% resistance to crushing damage",
        "Increases melee weapon damage by 5% for 30 seconds"
        ],
        vendor: 'midlands',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'midlands_steel_talisman': {
        ...
        description: "A plate of hardened steel, forged from the heart of a fallen Shadeward colossus. Worn by those who dare to stand against the Onyx Hand’s grip — it hums with ancient industrial rage and whispers secrets of the Iron Legion’s forgotten founders.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3500,
        icon: '📦',
        stock: 2,
        rarity: 'rare',
        effects: [
            "+20% damage to heavy armor enemies",
        "Grants immunity to suffocation in underground mines",
        "When damaged, emits a pulse that shatters nearby steel barriers"
        ],
        vendor: 'midlands',
        shippedBy: 'Koopa Postal',
        levelRequirement: 6
  ...
  'midlands_steel_tongue_belt': {
        ...
        description: "A belt forged from the remains of a defunct factory tongue-whistle. Wearing it grants the wearer the ability to speak in the language of the iron forge, making it a potent tool for negotiation or subterfuge.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3000,
        icon: '🔮',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Grants +50% persuasion chance when speaking to NPCs",
        "Reduces enemy suspicion of the wearer by 30%",
        "Grants +10% damage when used with a weapon that has a “scream” effect"
        ],
        vendor: 'midlands',
  ...
  'midlands_sword_of_the_gutter': {
        ...
        description: "A blade forged from reclaimed industrial waste, its edge gleams with the memory of a thousand gears. Inflicts 10% more damage to machinery and grants a 5% chance to disable enemy gear.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2000,
        icon: '🔮',
        stock: 4,
        rarity: 'rare',
        effects: [
            "Deals +10% damage to mechanical targets",
        "5% chance to disable enemy gear on hit",
        "Grants +5% to strength when using tools"
        ],
        vendor: 'midlands',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 4
  ...
  'midlands_tainted_mech_glove': {
        ...
        description: "A rusted gauntlet forged from scavenged ironwork and cursed industrial residue. Grants temporary mechanical augmentation while resisting blunt force, but drains sanity with prolonged use.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "+20% damage to crushing attacks",
        "-10% movement speed while active",
        "10% chance to trigger “Mechanic’s Fury” on critical hits"
        ],
        vendor: 'midlands',
        shippedBy: 'Void Drifter Relay',
        levelRequirement: 5
  ...
  'midlands_tarnished_gear': {
        ...
        description: "A relic from the forge of the Iron Legion’s forgotten workshop — its surface is etched with runes that whisper the secrets of steel and sacrifice. Wearing it grants the wielder temporary resistance to mechanical traps.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3500,
        icon: '🔮',
        stock: 2,
        rarity: 'rare',
        effects: [
            "+15% chance to disarm mechanical traps",
        "+5% chance to ignore lock mechanisms on industrial doors",
        "Grants 10% bonus to damage from strikes against machinery"
        ],
        vendor: 'midlands',
        shippedBy: 'Pipe Express',
        levelRequirement: 6
  ...
  'midlands_tin_iron_soul': {
        ...
        name: "Tin Iron Soul",
        description: "A cursed relic of the old ironsmiths’ guild, infused with the memory of a fallen blacksmith’s spirit. Wearing it grants the user a strange sense of kinship with the iron, granting them temporary immunity to blunt damage from heavy machinery.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Immunity to blunt damage for 30 seconds",
        "Increases weapon damage by 5% while wielding iron tools",
        "Reduces stamina cost of heavy lifting by 10%"
        ],
        vendor: 'midlands',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'midlands_titanic_crown_of_steel': {
        ...
        description: "A crown forged from the remains of a fallen war machine. Grants immense protection and boosts morale during siege battles.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 4000,
        icon: '🏰',
        stock: 2,
        ...
        "+10% chance to trigger Siege Surge (increases damage by 50% for 2 turns)"
        ],
        vendor: 'midlands',
        shippedBy: 'Void Drifter Relay',
        levelRequirement: 5
  ...
  'midlands_titanium_key': {
        ...
        description: "A cold, unyielding key forged from industrial-grade alloy. It unlocks not just doors but the hidden truths of the Legion’s past. Holding it grants the wearer temporary visions of forgotten military archives.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 2500,
        icon: '🔑',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Grants +1 to History or Investigation checks when uncovering Legion secrets",
        "Causes temporary dizziness if used in non-industrial zones (due to “wrongness”)",
        "When used, triggers a 1-minute vision of the Iron Vault’s interior, revealing hidden rooms or data"
        ],
        vendor: 'midlands',
        shippedBy: 'Shy Guy Smugglers',
        levelRequirement: 5
  ...
  'midlands_titanium_shield': {
        ...
        description: "A plate of forged titanium, shaped from the last remnants of a collapsed factory tower. Grants near-impenetrable defense and allows the user to “redirect” incoming damage as a shockwave.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        "Grants 50% chance to reflect damage as a shockwave",
        "Restores 10% HP per 3 seconds of active defense"
        ],
        vendor: 'midlands',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
  ...
  'midlands_toad_fang': {
        ...
        description: "A relic from the Toad’s last rebellion. Carved from hardened steel, it glints with the memory of their defiance. Only the bravest dare wield it.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 2500,
        icon: '🔮',
        stock: 3,
        ...
        "+10% chance to summon a Toad’s Roar (area debuff for 3 turns)",
        "Restores 50% HP after 1 turn of combat"
        ],
        vendor: 'midlands',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
  ...
  'midlands_toad_marrow_ash': {
        ...
        description: "A powder derived from the bones of executed Toads. When inhaled, it induces visions of past executions and enhances combat intuition.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 1500,
        icon: '🔮',
        stock: 5,
        rarity: 'uncommon',
        effects: [
            "+15% movement speed for 3 turns",
        "+10% critical hit chance",
        "+5% chance to trigger “Execution Echo” (temporary stun on first enemy)"
        ],
        vendor: 'midlands',
        shippedBy: 'Koopa Postal',
        levelRequirement: 4
  ...
  'midlands_toll_of_the_iron_honour': {
        ...
        description: "A ceremonial iron coin stamped with the insignia of a fallen legion. When used, it grants temporary immunity to traps and increases the chance of finding hidden industrial relics.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 1500,
        icon: '🔮',
        stock: 1,
        rarity: 'rare',
        effects: [
            "Grants immunity to trap effects for 3 turns",
        "20% chance to find hidden industrial relic on next area check",
        "Grants +5% to morale when used in combat"
        ],
        vendor: 'midlands',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'midlands_tome_of_the_mechanical_soul': {
        ...
        description: "A cursed grimoire that binds the soul of a forgotten automaton. Reading it grants temporary flight and unlocks hidden industrial mechanisms in the environment.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 4000,
        icon: '📖',
        stock: 1,
        ...
        "Reveals hidden industrial mechanisms (usable once)",
        "Grants 20% chance to ignore environmental obstacles"
        ],
        vendor: 'midlands',
        shippedBy: 'Boo Spectral Mail',
        levelRequirement: 5
  ...
  'midlands_tongue_of_the_tin_mill': {
        ...
        description: "A spiked iron tongue carved from the remains of a collapsed ore processing mill. Sucks in enemy noise and converts it into raw material, granting a temporary boost to mining efficiency.",
        category: SHOP_CATEGORIES.CONSUMABLE,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Consuming this item grants 30% increased mining speed for 1 minute",
        "Depletes 10% of your stamina after use",
        "Grants +5% chance to find hidden ore veins in adjacent terrain"
        ],
        vendor: 'midlands',
        shippedBy: 'Lakitu Drones',
        levelRequirement: 5
  ...
  'midlands_tungsten_tide_spirit': {
        ...
        description: "A spirit-bound artifact that channels the pressure of the industrial tide. Grants a temporary shield and allows the wielder to push through enemy lines like a piston.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3000,
        icon: '📦',
        stock: 1,
        ...
        effects: [
            "+300 shield",
        "+2000 movement speed for 3 turns",
        "+100% chance to trigger “Industrial Surge” (next attack deals 50% more damage)",
