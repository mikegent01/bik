...
export const ITEMS_066 = {
    ...
    'doughnut_hole_gravitational_crumb': {
        id: 'doughnut_hole_gravitational_crumb',
        name: "Void Crumb",
        description: "These tiny crumbs seem to defy gravity, floating around your hand with unsettling glee! Eating one grants a minor boost to movement speed and a slight chance of attracting small, shimmering anomalies.",
        category: SHOP_CATEGORIES.CONSUMABLES,
        price: 250,
        icon: '✨',
        stock: 78,
        ...
        stockType: 'in_stock',
        effects: [
            "increased_movement_speed_10",
            "chance_anomaly_summon",
            "minor_healing_5"
        ],
        vendor: 'hole_hawker',
    ...
    'internet_blackhole_shard': {
        id: 'internet_blackhole_shard',
        name: "Void Echo Fragment",
        description: "A piece of a forgotten server, radiating with the emptiness of deleted data. This shard can temporarily warp reality around you – but be warned, it attracts unwanted attention from the deeper reaches of the internet.",
        category: SHOP_CATEGORIES.FORBIDDEN,
        price: 6200,
        icon: '👾',
        stock: 7,
        ...
        stockType: 'night_only',
        effects: [
            "Chance to teleport the target a short distance (5-10 feet)",
            "Causes enemies within 3 meters to become 'offline' for 1 turn",
            "Risk of attracting a hostile AI entity"
        ],
        vendor: 'cyber_market',
