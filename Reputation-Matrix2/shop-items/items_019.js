...
export const ITEMS_019 = {
  ...
  "goomba_mask": {
    ...
    "rarity": "uncommon",
    "effects": [
      "Goombas will not attack you unless provoked",
      "Cannot speak while wearing"
    ],
  ...
  "gradual_syrup": {
    ...
    "rarity": "uncommon",
    "effects": [
      "Regain 1 Spell Slot level at the start of your turn for 3 turns"
    ],
    "vendor": "toad_town_market",
  ...
  "guide_to_snifits": {
    ...
    "rarity": "common",
    "effects": [
      "Advantage on INT checks regarding Snifits"
    ],
    "vendor": "toad_town_market",
    "shippedBy": "Book Mail",
    "levelRequirement": 1
