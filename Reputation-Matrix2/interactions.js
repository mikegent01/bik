...
function showEnding() {
    ...
    const sequence = [
        ...
        { delay: 8500, html: `<p class="text-purple-300 mt-6 text-reveal">You see structures—</p>` },
        { delay: 10000, html: `<p class="text-cyan-300 mt-2 text-reveal">Towers. Eyes. Grids. Roots.</p>` },
        { delay: 11500, html: `<p class="text-gray-400 mt-2 text-reveal">Things that ARE, beyond the room.</p>` },
