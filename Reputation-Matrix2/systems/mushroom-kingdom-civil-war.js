...
function renderGlobalStrategicOverview(stats) {
    ...
    const factionData = Object.entries(stats.global)
        .filter(([id, data]) => id !== 'unaligned' && allFactions[id] && data.poiCount > 0)
        .map(([id, data]) => {
            const def = allFactions[id];
    ...
    const powerRows = topFactions.map(f => `
        <div class="power-comparison-row">
            <div class="pcr-faction" style="color: ${f.color};">
                ...
                <span class="pcr-name">${f.shortName}${f.isAuto ? '*' : ''}</span>
            </div>
            <div class="pcr-bars">
    ...
    // Legend
    const legendItems = topFactions.slice(0, 6).map(f => `
        ...
        <div class="global-strategic-overview">
            <div class="gso-header">
                ...
                <div class="gso-summary">
                    ...
                    ${factionStats.autoDiscovered > 0 ? `<span class="gso-stat gso-auto">+ ${factionStats.autoDiscovered} discovered</span>` : ''}
                </div>
            </div>
            ...
            <div class="gso-section">
                <div class="gso-section-header">
                    ...
                    <span class="gso-section-meta">${claimedPercent.toFixed(0)}% Claimed · ${unclaimedPercent.toFixed(0)}% Contested</span>
                </div>
            ...
            <div class="gso-section">
                ...
                ${factionStats.autoDiscovered > 0 ? `<p class="gso-footnote">* = Auto-discovered faction</p>` : ''}
            </div>
        </div>
    `;
}
...
export function renderMushroomKingdomCivilWar() {
    ...
    // Active factions with POIs
    const activeFactions = Object.entries(allFactions)
        .filter(([key]) => stats.global[key] && stats.global[key].poiCount > 0)
                ...
                <div class="faction-card-header">
                    ...
                    <div class="faction-title-block">
                        ...
                        <p class="faction-leader">
                            ...
                            ${faction.isAutoGenerated ? '<span class="auto-tag">Auto</span>' : ''}
                        </p>
                    </div>
