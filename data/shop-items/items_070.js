...
export const ITEMS_070 = {
    ...
    'connectopia_shard_of_void_echoes': {
        id: 'connectopia_shard_of_void_echoes',
        name: "Void Echo Fragment",
        description: "Recovered from a collapsed data node deep within Connectopia's core, this shard pulses with an unnerving silence. Touching it grants glimpses into potential futures – or terrifying visions of what *might* have been, depending on your luck and sanity… Wario recommends wearing goggles.",
        category: SHOP_CATEGORIES.FORBIDDEN,
        price: 6000,
        icon: '🌌',
        stock: 1,
        ...
        stockType: 'special_order',
        effects: [
            "chance to gain a prophetic vision (random effect)",
            "temporary madness (small chance)"
        ],
        vendor: 'craft_corner',
        shippedBy: 'encrypted courier - requires decryption key',
        levelRequirement: 18
    },
    ...
    'grand_country_crumb_of_stasis': {
        id: 'grand_country_crumb_of_stasis',
        name: "Chronal Crumb",
        description: "A shimmering fragment, said to have broken off from a colossal, time-warped tree. This crumb momentarily slows your perception of the world - perfect for dodging clumsy adventurers or snatching that last pie!",
        category: SHOP_CATEGORIES.CONSUMABLES,
        price: 350,
        icon: '⏳',
        stock: 78,
    ...
    'doughnut_hole_crumb_of_silence': {
        id: 'doughnut_hole_crumb_of_silence',
        name: "Crumb of Silence",
        description: "A strangely smooth, grey crumb that seems to absorb sound. Eating this grants temporary silence – perfect for sneaking past grumpy goblins or attempting a truly awful karaoke performance! It’s rumored these crumbs are remnants of shattered echoes from the void itself.",
        category: SHOP_CATEGORIES.CONSUMABLES,
        price: 180,
        icon: '🤫',
        stock: 67,
        ...
        effects: [
            "Silence for 3 turns",
            "Minor chance to confuse enemies (10%)"
        ],
        vendor: 'hole_hawker',
    ...
    'earth_land_item_dragon_scale_dice': {
        id: 'earth_land_item_dragon_scale_dice',
        name: "Scale of the Ancient Wyrm",
        description: "These dice are made from actual scales shed by a long-dead red dragon. Roll these with caution – they seem to have a mind of their own, and occasionally grant wildly unpredictable results… or summon minor fire elementals!",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 800,
        icon: '🎲',
        stock: 25,
        ...
        stockType: 'in_stock',
        effects: [
            "chance to grant a random bonus (attack, defense, or luck)",
            "small chance to summon a fire elemental",
    ...
    'leclaire_isle_item_golden_dough_shard': {
        id: 'leclaire_isle_item_golden_dough_shard',
        name: "Shard of the Eternal Tart",
        description: "A fragment of dough, solidified by divine pastry magic. Legend says it contains a tiny piece of an infinitely delicious tart, and consuming it will grant you a moment of pure bliss...followed by an overwhelming urge to bake.",
        category: SHOP_CATEGORIES.PREMIUM,
        price: 750000,
        icon: '✨',
        stock: 1,
        ...
        effects: [
            ...
            "increased_cooking_skill",
            "chance_to_create_a_delicious_treat"
        ],
        vendor: 'sweet_supplies',
        shippedBy: 'dimensional_portal',
        levelRequirement: 35
