...
export const ITEMS_065 = {
    ...
    'teyvat_item_geomagnetic_shard': {
        id: 'teyvat_item_geomagnetic_shard',
        name: "Stone Singer's Echo",
        description: "A strangely resonant shard of earth, pulsing with elemental energy. Hold it to your ear and you might hear the whispers of ancient dragons... or just a really loud echo.",
        ...
        stockType: 'limited_daily',
        effects: [
            "chance to trigger a minor earth tremor (5%)",
            "increased mining speed (10%)",
            "small defense buff (3)"
        ],
        vendor: 'liyue_harbor',
        shippedBy: 'sea_cart',
        levelRequirement: 5
    ...
    'teyvat_item_emberclaw_amulet': {
        id: 'teyvat_item_emberclaw_amulet',
        name: "Emberclaw Amulet",
        description: "This fiery amulet pulses with the heat of the Sun, offering a warm glow and a surprisingly effective deterrent against chilly winds. Wario would totally wear this to keep his mushrooms from getting cold!",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 18000,
        icon: '🔥',
        stock: 7,
