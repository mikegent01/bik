...
| [`battles/README.md`](battles/README.md) | **Battle articles** — fights big enough to own their documentation; format, ledger-truth rules, index | Documenting a major battle |
