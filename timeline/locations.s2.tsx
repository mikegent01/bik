...
export const LOCATIONS_DATA_S2: Location[] = [
    ...
    {
        id: 'the_mad_ship',
        name: 'The Mad Ship (Luxury Liner)',
        description: "A colossal luxury liner that served as the team's transport, inducing paranoia and violence. Its engine room was ultimately rigged with TNT and destroyed, and the vessel finally sank after flooding completely during a storm, forcing the team to escape in a lifeboat.",
    ...
    },
    {
        id: 'ss_titanic',
        name: 'S.S. Titanic',
        description: "A surreal and ghostly recreation of the famous luxury liner found adrift in the storm. The team descended into a sudden and brutal massacre of its other passengers, ultimately destroying the legendary ship with explosives. It loomed over them as they escaped their own sinking vessel.",
        firstAppearanceEpisode: 68,
        lastAppearanceEpisode: 72,
    },
    {
        id: 'rms_titanic',
        name: "RMS Titanic (Undead Vessel)",
        description: "The legendary ocean liner, found derelict and swarming with zombies, skeletons, and pigmen. It served as a prison for the team's friends and the site of a brutal ambush in its industrial lower decks before the team rigged its engine room and the ship itself with explosives.",
        firstAppearanceEpisode: 69,
        lastAppearanceEpisode: 71,
    },
    {
        id: 'stormy_sea',
        name: 'The Stormy Sea (Adrift)',
        description: 'The tumultuous, storm-tossed stretch of ocean where the team found themselves adrift in a small lifeboat after escaping their sinking luxury liner. They are left vulnerable, in the shadow of the S.S. Titanic.',
