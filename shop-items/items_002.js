// Shop items chunk 2 of 51
// Items 101 to 200 (100 items)
...
export const ITEMS_002 = {
  ...
  'a_resonant_artifact_that_amplifies_1': {
        id: 'a_resonant_artifact_that_amplifies_1',
        name: "Echo of the Triforce",
        description: "A resonant artifact that amplifies the wielder’s willpower and grants them a chance to restore lost health during combat. Flickers with the light of the Triforce’s three virtues.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 3000,
        icon: '🔮',
        stock: 2,
        rarity: 'rare',
        effects: [
            "Restores 20% of max HP on critical hit",
  ...
  'a_ring_that_pulses_with_2': {
        id: 'a_ring_that_pulses_with_2',
        name: "Doughnut Edge Ring",
  ...
  'a_small_metallic_key_that_1': {
        id: 'a_small_metallic_key_that_1',
        name: "Shadowfell Keychain",
        description: "A small metallic key that unlocks portals to the Shadowfell—a realm of twisted reality. When worn, it allows the wearer to briefly step into the shadowed plane to recover lost items or confront shadow-dwelling horrors.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "Grants access to one Shadowfell portal per day",
        "+20% damage against shadow-based enemies",
        "Grants temporary resistance to fear effects when in Shadowfell"
        ],
        vendor: 'faerun',
  ...
  'a_small_pulsing_amulet_that_1': {
        id: 'a_small_pulsing_amulet_that_1',
        name: "Echo Talisman",
        description: "A small, pulsing amulet that echoes the last thought of whoever last touched it. Useful for locating lost allies or triggering forgotten Fey memories.",
        ...
        rarity: 'rare',
        effects: [
            "Triggers a memory echo upon activation (random Fey court lore)",
        "Allows the user to hear a voice from 100 yards away (for 30 seconds)",
        "If used near a time loop, it can briefly break the loop (10% chance)"
        ],
        vendor: 'feywild',
  ...
  'a_volatile_explosive_infused_with_1': {
        id: 'a_volatile_explosive_infused_with_1',
        name: "Garlic Bomb",
  ...
  'a_weapon_forged_from_condensed_40': {
        id: 'a_weapon_forged_from_condensed_40',
        name: "Crystal Blade",
