...
export const ITEMS_054 = {
    ...
    'teyvat_item_wind_whisper_scroll': {
        id: 'teyvat_item_wind_whisper_scroll',
        name: "Inazuma's Silent Blessing",
        description: "This scroll, imbued with the essence of Inazuma’s storms, allows you to briefly manipulate the winds. Use it wisely – or be swept away by a sudden gust! Seriously, don’t blame me if you end up face-planting into a cliff.",
        category: SHOP_CATEGORIES.CURIOSITIES,
        price: 3200,
        icon: '💨',
        stock: 35,
        ...
        stockType: 'night_only',
        effects: [
            "grants a short burst of increased movement speed (5 seconds)",
            "chance to deflect projectiles (15%)",
            "reduces falling damage by 20%"
        ],
        vendor: 'inazuma_imports',
        shippedBy: 'Stormhawk Delivery',
        levelRequirement: 8
    },
    ...
    'earth_land_rusty_dragonscale': {
        id: 'earth_land_rusty_dragonscale',
        name: "Dragonscale Shard of Grumblegut",
        description: "This jagged piece of what might have once been a dragon’s hide smells faintly of burnt toast and disappointment. It's surprisingly warm to the touch, and Wario swears he can hear it grumbling about being dropped.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 7500,
        icon: '🔥',
        stock: 12,
        ...
        effects: [
            "armor_class +2",
            "fire_resistance 10%",
            "chance to inflict minor burns on melee attacks"
        ],
