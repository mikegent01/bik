...
export const ITEMS_063 = {
    ...
    'kivotos_item_chronometric_charm': {
        id: 'kivotos_item_chronometric_charm',
        name: "Temporal Tickle",
        description: "This bizarre charm seems to vibrate with the frantic energy of a student cramming for an exam. When activated, it briefly slows down time around you, giving you an edge in combat or allowing you to snatch that last donut… or maybe just avoid tripping.",
        category: SHOP_CATEGORIES.CONSUMABLES,
        price: 1800,
        icon: '⏳',
        stock: 42,
        ...
        effects: [
            "slows_time_by_25%",
            "restores_mana_10",
            "chance_to_trigger_temporal_distortion (10%)"
        ],
