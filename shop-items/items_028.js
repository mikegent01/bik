// Shop items chunk 28 of 51
// Items 2701 to 2800 (100 items)
...
export const ITEMS_028 = {
  ...
  'midlands_ironclad_gear': {
        id: 'midlands_ironclad_gear',
        name: "Ironclad Gear",
        description: "Reinforced with slag-steel and forge-forged rivets this gear resists blunt force and heat. Worn by the Iron Legion’s toughest laborers, it whispers of the furnace’s roar.",
        category: SHOP_CATEGORIES.EQUIPMENT,
        price: 2500,
        icon: '🔮',
        stock: 3,
        rarity: 'rare',
        effects: [
            "+20% armor against blunt trauma",
        "+10% chance to ignore terrain obstacles",
        "+5% damage dealt to iron-based enemies"
        ],
        vendor: 'midlands',
        shippedBy: 'Pipe Express',
        levelRequirement: 5
