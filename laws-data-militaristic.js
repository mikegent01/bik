...
export const MILITARISTIC_CODES = {
    ...
    iron_legion: {
        ...
        military: [
            ...
            {
                name: "Standing Protocols of Engagement",
                policy: "Field Engagement Protocols",
                spectrum: [
                    { name: "Protocol One", description: "Protocol one, be courteous and allow your opponent the first attack." },
                    { name: "Protocol Two", description: "protocol two: attack back! It is time to show you the true strength of a iron legion." },
                    { name: "Protocol Six", description: "Protocol Six Retreat if you must. Your life is important too." }
                ],
                current: 1,
                trend: 0,
                description: "Standing directives for field engagement: Protocol One requires courtesy and allowing the opponent the first strike; Protocol Two mandates: attack back! It is time to show you the true strength of a iron legion; Protocol Six states: Protocol Six Retreat if you must. Your life is important too."
            }
        ],
        economic: [
            {
