...
export const MIDLANDS_TROOPS = [
    ...
    { id: 'mid_troop_12', mapId: 'midlands_full', x: 18.0, y: 82.0, factionId: 'onyx_hand', name: "Ebonspire Manor Guard", unitType: 'garrison', strength: "Vampire Knights & Thralls", details: { status: "Guarding", objective: "Protect the Onyx Hand's regional seat of power.", supply_level: 95, morale: 80, organization: 90, intelReq: { faction: 'onyx_hand', level: 40 } } },
    { id: 'mid_troop_13', mapId: 'midlands_full', x: 44.0, y: 62.0, factionId: 'unaligned', name: "Gilded Gryphon Mercenaries", unitType: 'garrison', strength: "Mercenary Company", details: { status: "Under Contract", objective: "Pacify the Lower Hills region on behalf of the Regal Empire.", supply_level: 70, morale: 70, organization: 80, intelReq: { faction: 'regal_empire', level: 25 } } },
    { id: 'mid_troop_14', mapId: 'midlands_full', x: 35.0, y: 15.0, factionId: 'iron_legion', name: "Fort Ironhand Main Force", unitType: 'garrison', strength: "Western Divisions HQ", details: { status: "Garrisoned", objective: "Project Imperial power into the western provinces and counter the Rakasha Clans.", supply_level: 100, morale: 95, organization: 95, intelReq: { faction: 'iron_legion', level: 20 } } },
    { id: 'mid_troop_15', mapId: 'midlands_full', x: 25.0, y: 15.0, factionId: 'rakasha_clans', name: "Ironwood Border Patrol", unitType: 'patrol', strength: "Rakasha Warriors", path: "M 25,15 L 28,18 L 24,19 Z", details: { status: "Defending", objective: "Protect the Rakasha hunting grounds from Imperial encroachment.", supply_level: 60, morale: 85, organization: 75, intelReq: { faction: 'rakasha_clans', level: 40 } } },
    { id: 'mid_troop_16', mapId: 'midlands_full', x: 77.0, y: 20.0, factionId: 'iron_legion', name: "Fort Horizon Garrison", unitType: 'garrison', strength: "Heavy Infantry", details: { status: "Guarding", objective: "Protect the northern approach to the crucial trade hub of Vemia City.", supply_level: 90, morale: 90, organization: 95, intelReq: { faction: 'iron_legion', level: 25 } } },
    { id: 'mid_troop_17', mapId: 'midlands_full', x: 65.0, y: 5.0, factionId: 'iron_legion', name: "Stonebridge Keep Garrison", unitType: 'garrison', strength: "Veteran Legionnaires", details: { status: "Securing", objective: "Guard the northern border of Yal Belanor province under Sir Reginald Stonebridge.", supply_level: 85, morale: 95, organization: 95, intelReq: { faction: 'iron_legion', level: 35 } } },
    { id: 'mid_troop_18', mapId: 'midlands_full', x: 60.0, y: 88.0, factionId: 'silver_flame', name: "Fort Vigilance Crusaders", unitType: 'main_force', strength: "Crusader Host", details: { status: "Preparing Offensive", objective: "Prepare a major crusade into the werewolf badlands of Theghdural.", supply_level: 80, morale: 100, organization: 85, intelReq: { faction: 'silver_flame', level: 40 } } },
    { id: 'mid_troop_19', mapId: 'midlands_full', x: 63.0, y: 95.0, factionId: 'moonfang_pack', name: "Silver Mine Raiders", unitType: 'ambush', strength: "Werewolf Raiders", details: { status: "Harassing", objective: "Continuously harass and sabotage the Iron Legion's silver mining operations.", supply_level: 40, morale: 70, organization: 50, intelReq: { faction: 'moonfang_pack', level: 50 } } },
    ...
    { id: 'mid_troop_26', mapId: 'midlands_full', x: 78.0, y: 40.0, factionId: 'unaligned', name: "Temple of the Gilded Hand Guard", unitType: 'garrison', strength: "Temple Guard", details: { status: "Protecting", objective: "Protect the temple and its treasures from thieves.", supply_level: 80, morale: 70, organization: 70, intelReq: { faction: 'regal_empire', level: 20 } } },
    { id: 'mid_troop_27', mapId: 'midlands_full', x: 55.0, y: 80.0, factionId: 'unaligned', name: "Centaur Plains Riders", unitType: 'patrol', strength: "Centaur Warriors", path: "M 55,80 L 58,78 L 54,76 Z", details: { status: "Defending", objective: "Protect their grazing lands from Imperial expansion.", supply_level: 60, morale: 80, organization: 65, intelReq: { faction: 'rebel_clans', level: 25 } } },
    { id: 'mid_troop_28', mapId: 'midlands_full', x: 68.0, y: 65.0, factionId: 'cosmic_jesters', name: "The Random Bridge 'Guard'", unitType: 'patrol', strength: "One Jester", path: "M 68,65 L 67,63 L 69,63 Z", details: { status: "Guarding?", objective: "Ensure the bridge remains as random and unhelpful as possible.", supply_level: 100, morale: 100, organization: 5, intelReq: { faction: 'cosmic_jesters', level: 30 } } },
    { id: 'mid_troop_29', mapId: 'midlands_full', x: 10.0, y: 88.0, factionId: 'onyx_hand', name: "Briar's Hollow Thralls", unitType: 'garrison', strength: "Dominated Mortals", details: { status: "Serving", objective: "Serve as a buffer defense and a food source for the main coven.", supply_level: 20, morale: 20, organization: 30, intelReq: { faction: 'onyx_hand', level: 25 } } },
    { id: 'mid_troop_30', mapId: 'midlands_full', x: 5.0, y: 7.0, factionId: 'rebel_clans', name: "The Last Hearth Sentinels", unitType: 'garrison', strength: "Hardened Veterans", details: { status: "Defending", objective: "Protect the last bastion of the free Northern Clans.", supply_level: 50, morale: 90, organization: 60, intelReq: { faction: 'rebel_clans', level: 50 } } },
    { id: 'mid_troop_31', mapId: 'midlands_full', x: 48.0, y: 65.0, factionId: 'iron_legion', name: "Crossroads Keep Supply Convoy", unitType: 'patrol', strength: "Wagons & Guards", path: "M 48,65 L 53,68 L 50,71 Z", details: { status: "Supplying", objective: "Transport vital supplies to Crossroads Keep through rebel-contested territory.", supply_level: 100, morale: 80, organization: 85, intelReq: { faction: 'iron_legion', level: 30 } } },
    { id: 'mid_troop_32', mapId: 'midlands_full', x: 33.0, y: 18.0, factionId: 'rakasha_clans', name: "Ironwood Ambush Party", unitType: 'ambush', strength: "Rakasha Huntmasters", details: { status: "Hunting", objective: "Ambush Imperial logging patrols to disrupt their operations.", supply_level: 60, morale: 85, organization: 70, intelReq: { faction: 'rakasha_clans', level: 55 } } },
    { id: 'mid_troop_33', mapId: 'midlands_full', x: 39.0, y: 43.0, factionId: 'silver_flame', name: "Inquisitor Squad Vale", unitType: 'special_ops', strength: "Elite Inquisitors", details: { status: "Investigating", objective: "Secretly investigate rumors of demonic influence within the Onyx Hand's leadership at Bloodmoon Manor.", supply_level: 90, morale: 100, organization: 90, intelReq: { faction: 'silver_flame', level: 65 } } },
    { id: 'mid_troop_34', mapId: 'midlands_full', x: 36.5, y: 42.5, factionId: 'freelancer_underworld', name: "Crossroads Inn Spies", unitType: 'special_ops', strength: "Information Brokers", details: { status: "Listening", objective: "Gather intelligence from all factions passing through the inn and sell it to the highest bidder.", supply_level: 100, morale: 60, organization: 85, intelReq: { faction: 'freelancer_underworld', level: 25 } } },
    { id: 'mid_troop_35', mapId: 'midlands_full', x: 15.0, y: 75.0, factionId: 'onyx_hand', name: "Sanguinarium Guard", unitType: 'garrison', strength: "Bloodsworn Guards", details: { status: "Protecting", objective: "Defend the coven's primary food source from Silver Flame incursions.", supply_level: 80, morale: 75, organization: 80, intelReq: { faction: 'onyx_hand', level: 50 } } },
